...
var _JeremyBellows$elm_bootstrapify$Bootstrap_Buttons$getButtonModifierAttribute = function (btnModifier) {
	...
	return _elm_lang$core$Native_List.fromArray(
		[
			...
			A2(_elm_lang$html$Html_Attributes$attribute, 'data-target', _p0._0)
		]);
};
...
var _user$project$Mfa$renderMessage = function (str) {
	return A2(
...
var _user$project$Mfa$channelRow = function (channel) {
	return A2(
...
var _user$project$Mfa$channelsTable = function (channels) {
	return A2(
...
_user$project$Mfa_ops['=>'] = F2(
	function (v0, v1) {
		return {ctor: '_Tuple2', _0: v0, _1: v1};
	});
var _user$project$Mfa$page_waiting = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[]),
...
var _user$project$Mfa$Model2 = F2(
	function (a, b) {
		return {status: a, phxSocket: b};
	});
var _user$project$Mfa$ChatMessage = F3(
	function (a, b, c) {
		return {user: a, body: b, value: c};
	});
var _user$project$Mfa$chatMessageDecoder = A4(
	_elm_lang$core$Json_Decode$object3,
	_user$project$Mfa$ChatMessage,
...
var _user$project$Mfa$Waiting = {ctor: 'Waiting'};
var _user$project$Mfa$None = {ctor: 'None'};
var _user$project$Mfa$Ping = function (a) {
	return {ctor: 'Ping', _0: a};
};
var _user$project$Mfa$NoOp = {ctor: 'NoOp'};
var _user$project$Mfa$ShowLeftMessage = function (a) {
	return {ctor: 'ShowLeftMessage', _0: a};
};
var _user$project$Mfa$ShowJoinedMessage = function (a) {
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('The total is of $ 42.0 ')
					])),
				A5(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Events$onClick(_user$project$Mfa$JoinChannel)
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						A2(
...
var _user$project$Mfa$PhoenixMsg = function (a) {
	return {ctor: 'PhoenixMsg', _0: a};
};
var _user$project$Mfa$subscriptions = function (model) {
	return A2(_fbonetti$elm_phoenix_socket$Phoenix_Socket$listen, model.phxSocket, _user$project$Mfa$PhoenixMsg);
};
		...
		switch (_p3.ctor) {
			...
			case 'JoinChannel':
				var channel = A2(
					...
					_elm_lang$core$Basics$always(
						_user$project$Mfa$ShowLeftMessage('rooms:lobby')),
					A2(
						_fbonetti$elm_phoenix_socket$Phoenix_Channel$onJoin,
						_elm_lang$core$Basics$always(
							_user$project$Mfa$ShowJoinedMessage('rooms:lobby')),
						A2(
				...
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							phxSocket: A2(_elm_lang$core$Debug$log, 'phoenix socket on join', phxSocket)
						}),
					_1: A2(_elm_lang$core$Platform_Cmd$map, _user$project$Mfa$PhoenixMsg, phxCmd)
				};
			case 'LeaveChannel':
				...
				var payload = _elm_lang$core$Json_Encode$object(
					_elm_lang$core$Native_List.fromArray(
						[
							...
							ctor: '_Tuple2',
							_0: 'body',
							_1: _elm_lang$core$Json_Encode$string('42')
						}
						]));
				var push$ = A2(
					_fbonetti$elm_phoenix_socket$Phoenix_Push$withPayload,
			...
			case 'ReceiveAccepted':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{status: _user$project$Mfa$Accepted}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'ReceiveRejected':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{status: _user$project$Mfa$Rejected}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'ReceiveTimeout':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{status: _user$project$Mfa$Timeout}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'Ping':
...
var _user$project$Mfa$SendMessage = {ctor: 'SendMessage'};
var _user$project$Mfa$newMessageForm = function (model) {
	return A2(
		_elm_lang$html$Html$form,
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Events$onSubmit(_user$project$Mfa$SendMessage)
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$html$Html_Events$onInput(_user$project$Mfa$SetNewMessage)
					]),
				_elm_lang$core$Native_List.fromArray(
					[]))
			]));
};
var _user$project$Mfa$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[]),
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_user$project$Mfa$channelsTable(
				...
				_user$project$Mfa$newMessageForm(model),
				A2(
...
var _user$project$Mfa$ReceiveTimeout = function (a) {
	return {ctor: 'ReceiveTimeout', _0: a};
};
var _user$project$Mfa$ReceiveRejected = function (a) {
	return {ctor: 'ReceiveRejected', _0: a};
};
var _user$project$Mfa$ReceiveAccepted = function (a) {
	return {ctor: 'ReceiveAccepted', _0: a};
};
var _user$project$Mfa$initPhxSocket = A4(
	_fbonetti$elm_phoenix_socket$Phoenix_Socket$on,
	'timeout',
	'rooms:lobby',
	_user$project$Mfa$ReceiveTimeout,
	A4(
		_fbonetti$elm_phoenix_socket$Phoenix_Socket$on,
		'rejected',
		'rooms:lobby',
		_user$project$Mfa$ReceiveRejected,
		A4(
			_fbonetti$elm_phoenix_socket$Phoenix_Socket$on,
			'accepted',
			'rooms:lobby',
			_user$project$Mfa$ReceiveAccepted,
			A4(
				_fbonetti$elm_phoenix_socket$Phoenix_Socket$on,
				'waiting',
				'rooms:lobby',
				_user$project$Mfa$Ping,
				_fbonetti$elm_phoenix_socket$Phoenix_Socket$withDebug(
					_fbonetti$elm_phoenix_socket$Phoenix_Socket$init(_user$project$Mfa$socketServer))))));
var _user$project$Mfa$initModel = A5(
	_user$project$Mfa$Model,
	'',
	_elm_lang$core$Native_List.fromArray(
		[]),
	_user$project$Mfa$initPhxSocket,
	0,
...
var Elm = {};
Elm['Mfa'] = Elm['Mfa'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['Mfa'], 'Mfa', typeof _user$project$Mfa$main === 'undefined' ? null : _user$project$Mfa$main);
...
require.register("web/elm/Mfa", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/Fresheyeball/elm-font-awesome/2.0.0/FontAwesome/Brand", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/Fresheyeball/elm-font-awesome/2.0.0/FontAwesome/Brand/Class", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/Fresheyeball/elm-font-awesome/2.0.0/FontAwesome/Util", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/Fresheyeball/elm-font-awesome/2.0.0/FontAwesome/Web", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/Fresheyeball/elm-font-awesome/2.0.0/FontAwesome/Web/Class", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/JeremyBellows/elm-bootstrapify/8.0.0/src/Bootstrap/Buttons", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/JeremyBellows/elm-bootstrapify/8.0.0/src/Bootstrap/Forms", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/JeremyBellows/elm-bootstrapify/8.0.0/src/Bootstrap/Grid", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/JeremyBellows/elm-bootstrapify/8.0.0/src/Bootstrap/ListGroup", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/JeremyBellows/elm-bootstrapify/8.0.0/src/Bootstrap/Navbar", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/JeremyBellows/elm-bootstrapify/8.0.0/src/Bootstrap/Page", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/JeremyBellows/elm-bootstrapify/8.0.0/src/Bootstrap/Panels", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/JeremyBellows/elm-bootstrapify/8.0.0/src/Bootstrap/Wells", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/elm-lang/core/4.0.5/src/Array", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/elm-lang/core/4.0.5/src/Basics", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/elm-lang/core/4.0.5/src/Bitwise", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/elm-lang/core/4.0.5/src/Char", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/elm-lang/core/4.0.5/src/Color", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/elm-lang/core/4.0.5/src/Date", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/elm-lang/core/4.0.5/src/Debug", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/elm-lang/core/4.0.5/src/Dict", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/elm-lang/core/4.0.5/src/Json/Decode", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/elm-lang/core/4.0.5/src/Json/Encode", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/elm-lang/core/4.0.5/src/List", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/elm-lang/core/4.0.5/src/Maybe", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/elm-lang/core/4.0.5/src/Native/Array", function(exports, require, module) {
'use strict';
...
require.register("web/elm/elm-stuff/packages/elm-lang/core/4.0.5/src/Native/Basics", function(exports, require, module) {
'use strict';
...
require.register("web/elm/elm-stuff/packages/elm-lang/core/4.0.5/src/Native/Bitwise", function(exports, require, module) {
"use strict";
...
require.register("web/elm/elm-stuff/packages/elm-lang/core/4.0.5/src/Native/Char", function(exports, require, module) {
"use strict";
...
require.register("web/elm/elm-stuff/packages/elm-lang/core/4.0.5/src/Native/Date", function(exports, require, module) {
'use strict';
...
require.register("web/elm/elm-stuff/packages/elm-lang/core/4.0.5/src/Native/Debug", function(exports, require, module) {
'use strict';
...
require.register("web/elm/elm-stuff/packages/elm-lang/core/4.0.5/src/Native/Json", function(exports, require, module) {
'use strict';
...
require.register("web/elm/elm-stuff/packages/elm-lang/core/4.0.5/src/Native/List", function(exports, require, module) {
'use strict';
...
require.register("web/elm/elm-stuff/packages/elm-lang/core/4.0.5/src/Native/Platform", function(exports, require, module) {
'use strict';
...
require.register("web/elm/elm-stuff/packages/elm-lang/core/4.0.5/src/Native/Regex", function(exports, require, module) {
'use strict';
...
require.register("web/elm/elm-stuff/packages/elm-lang/core/4.0.5/src/Native/Scheduler", function(exports, require, module) {
'use strict';
...
require.register("web/elm/elm-stuff/packages/elm-lang/core/4.0.5/src/Native/String", function(exports, require, module) {
'use strict';
...
require.register("web/elm/elm-stuff/packages/elm-lang/core/4.0.5/src/Native/Time", function(exports, require, module) {
"use strict";
...
require.register("web/elm/elm-stuff/packages/elm-lang/core/4.0.5/src/Native/Utils", function(exports, require, module) {
'use strict';
...
require.register("web/elm/elm-stuff/packages/elm-lang/core/4.0.5/src/Platform", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/elm-lang/core/4.0.5/src/Platform/Cmd", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/elm-lang/core/4.0.5/src/Platform/Sub", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/elm-lang/core/4.0.5/src/Process", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/elm-lang/core/4.0.5/src/Random", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/elm-lang/core/4.0.5/src/Regex", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/elm-lang/core/4.0.5/src/Result", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/elm-lang/core/4.0.5/src/Set", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/elm-lang/core/4.0.5/src/String", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/elm-lang/core/4.0.5/src/Task", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/elm-lang/core/4.0.5/src/Time", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/elm-lang/core/4.0.5/tests/Test", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/elm-lang/core/4.0.5/tests/Test/Array", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/elm-lang/core/4.0.5/tests/Test/Basics", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/elm-lang/core/4.0.5/tests/Test/Bitwise", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/elm-lang/core/4.0.5/tests/Test/Char", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/elm-lang/core/4.0.5/tests/Test/CodeGen", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/elm-lang/core/4.0.5/tests/Test/Dict", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/elm-lang/core/4.0.5/tests/Test/Equality", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/elm-lang/core/4.0.5/tests/Test/Json", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/elm-lang/core/4.0.5/tests/Test/List", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/elm-lang/core/4.0.5/tests/Test/Regex", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/elm-lang/core/4.0.5/tests/Test/Result", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/elm-lang/core/4.0.5/tests/Test/Set", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/elm-lang/core/4.0.5/tests/Test/String", function(exports, require, module) {
...
;require.register("web/elm/elm-stuff/packages/elm-lang/svg/1.1.1/examples/Logo", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/elm-lang/svg/1.1.1/src/Svg", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/elm-lang/svg/1.1.1/src/Svg/Attributes", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/elm-lang/svg/1.1.1/src/Svg/Events", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/elm-lang/svg/1.1.1/src/Svg/Keyed", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/elm-lang/svg/1.1.1/src/Svg/Lazy", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/elm-lang/virtual-dom/1.1.1/src/Native/VirtualDom", function(exports, require, module) {
'use strict';
...
require.register("web/elm/elm-stuff/packages/elm-lang/virtual-dom/1.1.1/src/VirtualDom", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/elm-lang/virtual-dom/1.1.1/tests/Native/TestHelpers", function(exports, require, module) {
"use strict";
...
require.register("web/elm/elm-stuff/packages/elm-lang/virtual-dom/1.1.1/tests/TestCases/Lazy", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/elm-lang/virtual-dom/1.1.1/tests/TestHelpers", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/elm-lang/virtual-dom/1.1.1/tests/TestMain", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/elm-lang/websocket/1.0.1/src/Native/WebSocket", function(exports, require, module) {
'use strict';
...
require.register("web/elm/elm-stuff/packages/elm-lang/websocket/1.0.1/src/WebSocket", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/elm-lang/websocket/1.0.1/src/WebSocket/LowLevel", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/fbonetti/elm-phoenix-socket/2.0.0/examples/Chat", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/fbonetti/elm-phoenix-socket/2.0.0/src/Phoenix/Channel", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/fbonetti/elm-phoenix-socket/2.0.0/src/Phoenix/Helpers", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/fbonetti/elm-phoenix-socket/2.0.0/src/Phoenix/Push", function(exports, require, module) {

});

;require.register("web/elm/elm-stuff/packages/fbonetti/elm-phoenix-socket/2.0.0/src/Phoenix/Socket", function(exports, require, module) {

});

;require.register("web/elm/elm", function(exports, require, module) {
...
function update(oldRecord,updatedFields){var newRecord={};for(var key in oldRecord){var value=key in updatedFields?updatedFields[key]:oldRecord[key];newRecord[key]=value;}return newRecord;}//// LIST STUFF ////
...
function spawnLoop(init,onMessage){var andThen=_elm_lang$core$Native_Scheduler.andThen;function loop(state){var handleMsg=_elm_lang$core$Native_Scheduler.receive(function(msg){return onMessage(msg,state);});return A2(andThen,handleMsg,loop);}var task=A2(andThen,init,loop);return _elm_lang$core$Native_Scheduler.rawSpawn(task);}// BAGS
...
var init=_elm_lang$core$Native_Scheduler.succeed(null);function onEffects(router,cmdList,state){while(cmdList.ctor!=='[]'){var value=converter(cmdList._0);for(var i=0;i<subs.length;i++){subs[i](value);}cmdList=cmdList._1;}return init;}effectManagers[name].init=init;effectManagers[name].onEffects=F3(onEffects);// PUBLIC API
function subscribe(callback){subs.push(callback);}function unsubscribe(callback){var index=subs.indexOf(callback);if(index>=0){subs.splice(index,1);}}return{subscribe:subscribe,unsubscribe:unsubscribe};}// INCOMING PORTS
...
mainToProgram:mainToProgram,effectManagers:effectManagers,outgoingPort:outgoingPort,incomingPort:incomingPort,addPublicModule:addPublicModule,// effect bags
...
function programWithFlags(details){return{init:details.init,update:details.update,subscriptions:details.subscriptions,view:details.view,renderer:renderer};}return{node:node,text:text,custom:custom,map:F2(map),on:F3(on),style:style,property:F2(property),attribute:F2(attribute),attributeNS:F3(attributeNS),lazy:F2(lazy),lazy2:F3(lazy2),lazy3:F4(lazy3),keyedNode:F3(keyedNode),programWithFlags:programWithFlags};}();var _elm_lang$virtual_dom$VirtualDom$programWithFlags=_elm_lang$virtual_dom$Native_VirtualDom.programWithFlags;var _elm_lang$virtual_dom$VirtualDom$keyedNode=_elm_lang$virtual_dom$Native_VirtualDom.keyedNode;var _elm_lang$virtual_dom$VirtualDom$lazy3=_elm_lang$virtual_dom$Native_VirtualDom.lazy3;var _elm_lang$virtual_dom$VirtualDom$lazy2=_elm_lang$virtual_dom$Native_VirtualDom.lazy2;var _elm_lang$virtual_dom$VirtualDom$lazy=_elm_lang$virtual_dom$Native_VirtualDom.lazy;var _elm_lang$virtual_dom$VirtualDom$defaultOptions={stopPropagation:false,preventDefault:false};var _elm_lang$virtual_dom$VirtualDom$onWithOptions=_elm_lang$virtual_dom$Native_VirtualDom.on;var _elm_lang$virtual_dom$VirtualDom$on=F2(function(eventName,decoder){return A3(_elm_lang$virtual_dom$VirtualDom$onWithOptions,eventName,_elm_lang$virtual_dom$VirtualDom$defaultOptions,decoder);});var _elm_lang$virtual_dom$VirtualDom$style=_elm_lang$virtual_dom$Native_VirtualDom.style;var _elm_lang$virtual_dom$VirtualDom$attributeNS=_elm_lang$virtual_dom$Native_VirtualDom.attributeNS;var _elm_lang$virtual_dom$VirtualDom$attribute=_elm_lang$virtual_dom$Native_VirtualDom.attribute;var _elm_lang$virtual_dom$VirtualDom$property=_elm_lang$virtual_dom$Native_VirtualDom.property;var _elm_lang$virtual_dom$VirtualDom$map=_elm_lang$virtual_dom$Native_VirtualDom.map;var _elm_lang$virtual_dom$VirtualDom$text=_elm_lang$virtual_dom$Native_VirtualDom.text;var _elm_lang$virtual_dom$VirtualDom$node=_elm_lang$virtual_dom$Native_VirtualDom.node;var _elm_lang$virtual_dom$VirtualDom$Options=F2(function(a,b){return{stopPropagation:a,preventDefault:b};});var _elm_lang$virtual_dom$VirtualDom$Node={ctor:'Node'};var _elm_lang$virtual_dom$VirtualDom$Property={ctor:'Property'};var _elm_lang$html$Html$text=_elm_lang$virtual_dom$VirtualDom$text;var _elm_lang$html$Html$node=_elm_lang$virtual_dom$VirtualDom$node;var _elm_lang$html$Html$body=_elm_lang$html$Html$node('body');var _elm_lang$html$Html$section=_elm_lang$html$Html$node('section');var _elm_lang$html$Html$nav=_elm_lang$html$Html$node('nav');var _elm_lang$html$Html$article=_elm_lang$html$Html$node('article');var _elm_lang$html$Html$aside=_elm_lang$html$Html$node('aside');var _elm_lang$html$Html$h1=_elm_lang$html$Html$node('h1');var _elm_lang$html$Html$h2=_elm_lang$html$Html$node('h2');var _elm_lang$html$Html$h3=_elm_lang$html$Html$node('h3');var _elm_lang$html$Html$h4=_elm_lang$html$Html$node('h4');var _elm_lang$html$Html$h5=_elm_lang$html$Html$node('h5');var _elm_lang$html$Html$h6=_elm_lang$html$Html$node('h6');var _elm_lang$html$Html$header=_elm_lang$html$Html$node('header');var _elm_lang$html$Html$footer=_elm_lang$html$Html$node('footer');var _elm_lang$html$Html$address=_elm_lang$html$Html$node('address');var _elm_lang$html$Html$main$=_elm_lang$html$Html$node('main');var _elm_lang$html$Html$p=_elm_lang$html$Html$node('p');var _elm_lang$html$Html$hr=_elm_lang$html$Html$node('hr');var _elm_lang$html$Html$pre=_elm_lang$html$Html$node('pre');var _elm_lang$html$Html$blockquote=_elm_lang$html$Html$node('blockquote');var _elm_lang$html$Html$ol=_elm_lang$html$Html$node('ol');var _elm_lang$html$Html$ul=_elm_lang$html$Html$node('ul');var _elm_lang$html$Html$li=_elm_lang$html$Html$node('li');var _elm_lang$html$Html$dl=_elm_lang$html$Html$node('dl');var _elm_lang$html$Html$dt=_elm_lang$html$Html$node('dt');var _elm_lang$html$Html$dd=_elm_lang$html$Html$node('dd');var _elm_lang$html$Html$figure=_elm_lang$html$Html$node('figure');var _elm_lang$html$Html$figcaption=_elm_lang$html$Html$node('figcaption');var _elm_lang$html$Html$div=_elm_lang$html$Html$node('div');var _elm_lang$html$Html$a=_elm_lang$html$Html$node('a');var _elm_lang$html$Html$em=_elm_lang$html$Html$node('em');var _elm_lang$html$Html$strong=_elm_lang$html$Html$node('strong');var _elm_lang$html$Html$small=_elm_lang$html$Html$node('small');var _elm_lang$html$Html$s=_elm_lang$html$Html$node('s');var _elm_lang$html$Html$cite=_elm_lang$html$Html$node('cite');var _elm_lang$html$Html$q=_elm_lang$html$Html$node('q');var _elm_lang$html$Html$dfn=_elm_lang$html$Html$node('dfn');var _elm_lang$html$Html$abbr=_elm_lang$html$Html$node('abbr');var _elm_lang$html$Html$time=_elm_lang$html$Html$node('time');var _elm_lang$html$Html$code=_elm_lang$html$Html$node('code');var _elm_lang$html$Html$var=_elm_lang$html$Html$node('var');var _elm_lang$html$Html$samp=_elm_lang$html$Html$node('samp');var _elm_lang$html$Html$kbd=_elm_lang$html$Html$node('kbd');var _elm_lang$html$Html$sub=_elm_lang$html$Html$node('sub');var _elm_lang$html$Html$sup=_elm_lang$html$Html$node('sup');var _elm_lang$html$Html$i=_elm_lang$html$Html$node('i');var _elm_lang$html$Html$b=_elm_lang$html$Html$node('b');var _elm_lang$html$Html$u=_elm_lang$html$Html$node('u');var _elm_lang$html$Html$mark=_elm_lang$html$Html$node('mark');var _elm_lang$html$Html$ruby=_elm_lang$html$Html$node('ruby');var _elm_lang$html$Html$rt=_elm_lang$html$Html$node('rt');var _elm_lang$html$Html$rp=_elm_lang$html$Html$node('rp');var _elm_lang$html$Html$bdi=_elm_lang$html$Html$node('bdi');var _elm_lang$html$Html$bdo=_elm_lang$html$Html$node('bdo');var _elm_lang$html$Html$span=_elm_lang$html$Html$node('span');var _elm_lang$html$Html$br=_elm_lang$html$Html$node('br');var _elm_lang$html$Html$wbr=_elm_lang$html$Html$node('wbr');var _elm_lang$html$Html$ins=_elm_lang$html$Html$node('ins');var _elm_lang$html$Html$del=_elm_lang$html$Html$node('del');var _elm_lang$html$Html$img=_elm_lang$html$Html$node('img');var _elm_lang$html$Html$iframe=_elm_lang$html$Html$node('iframe');var _elm_lang$html$Html$embed=_elm_lang$html$Html$node('embed');var _elm_lang$html$Html$object=_elm_lang$html$Html$node('object');var _elm_lang$html$Html$param=_elm_lang$html$Html$node('param');var _elm_lang$html$Html$video=_elm_lang$html$Html$node('video');var _elm_lang$html$Html$audio=_elm_lang$html$Html$node('audio');var _elm_lang$html$Html$source=_elm_lang$html$Html$node('source');var _elm_lang$html$Html$track=_elm_lang$html$Html$node('track');var _elm_lang$html$Html$canvas=_elm_lang$html$Html$node('canvas');var _elm_lang$html$Html$svg=_elm_lang$html$Html$node('svg');var _elm_lang$html$Html$math=_elm_lang$html$Html$node('math');var _elm_lang$html$Html$table=_elm_lang$html$Html$node('table');var _elm_lang$html$Html$caption=_elm_lang$html$Html$node('caption');var _elm_lang$html$Html$colgroup=_elm_lang$html$Html$node('colgroup');var _elm_lang$html$Html$col=_elm_lang$html$Html$node('col');var _elm_lang$html$Html$tbody=_elm_lang$html$Html$node('tbody');var _elm_lang$html$Html$thead=_elm_lang$html$Html$node('thead');var _elm_lang$html$Html$tfoot=_elm_lang$html$Html$node('tfoot');var _elm_lang$html$Html$tr=_elm_lang$html$Html$node('tr');var _elm_lang$html$Html$td=_elm_lang$html$Html$node('td');var _elm_lang$html$Html$th=_elm_lang$html$Html$node('th');var _elm_lang$html$Html$form=_elm_lang$html$Html$node('form');var _elm_lang$html$Html$fieldset=_elm_lang$html$Html$node('fieldset');var _elm_lang$html$Html$legend=_elm_lang$html$Html$node('legend');var _elm_lang$html$Html$label=_elm_lang$html$Html$node('label');var _elm_lang$html$Html$input=_elm_lang$html$Html$node('input');var _elm_lang$html$Html$button=_elm_lang$html$Html$node('button');var _elm_lang$html$Html$select=_elm_lang$html$Html$node('select');var _elm_lang$html$Html$datalist=_elm_lang$html$Html$node('datalist');var _elm_lang$html$Html$optgroup=_elm_lang$html$Html$node('optgroup');var _elm_lang$html$Html$option=_elm_lang$html$Html$node('option');var _elm_lang$html$Html$textarea=_elm_lang$html$Html$node('textarea');var _elm_lang$html$Html$keygen=_elm_lang$html$Html$node('keygen');var _elm_lang$html$Html$output=_elm_lang$html$Html$node('output');var _elm_lang$html$Html$progress=_elm_lang$html$Html$node('progress');var _elm_lang$html$Html$meter=_elm_lang$html$Html$node('meter');var _elm_lang$html$Html$details=_elm_lang$html$Html$node('details');var _elm_lang$html$Html$summary=_elm_lang$html$Html$node('summary');var _elm_lang$html$Html$menuitem=_elm_lang$html$Html$node('menuitem');var _elm_lang$html$Html$menu=_elm_lang$html$Html$node('menu');var _elm_lang$html$Html_Attributes$attribute=_elm_lang$virtual_dom$VirtualDom$attribute;var _elm_lang$html$Html_Attributes$contextmenu=function _elm_lang$html$Html_Attributes$contextmenu(value){return A2(_elm_lang$html$Html_Attributes$attribute,'contextmenu',value);};var _elm_lang$html$Html_Attributes$draggable=function _elm_lang$html$Html_Attributes$draggable(value){return A2(_elm_lang$html$Html_Attributes$attribute,'draggable',value);};var _elm_lang$html$Html_Attributes$list=function _elm_lang$html$Html_Attributes$list(value){return A2(_elm_lang$html$Html_Attributes$attribute,'list',value);};var _elm_lang$html$Html_Attributes$maxlength=function _elm_lang$html$Html_Attributes$maxlength(n){return A2(_elm_lang$html$Html_Attributes$attribute,'maxlength',_elm_lang$core$Basics$toString(n));};var _elm_lang$html$Html_Attributes$datetime=function _elm_lang$html$Html_Attributes$datetime(value){return A2(_elm_lang$html$Html_Attributes$attribute,'datetime',value);};var _elm_lang$html$Html_Attributes$pubdate=function _elm_lang$html$Html_Attributes$pubdate(value){return A2(_elm_lang$html$Html_Attributes$attribute,'pubdate',value);};var _elm_lang$html$Html_Attributes$colspan=function _elm_lang$html$Html_Attributes$colspan(n){return A2(_elm_lang$html$Html_Attributes$attribute,'colspan',_elm_lang$core$Basics$toString(n));};var _elm_lang$html$Html_Attributes$rowspan=function _elm_lang$html$Html_Attributes$rowspan(n){return A2(_elm_lang$html$Html_Attributes$attribute,'rowspan',_elm_lang$core$Basics$toString(n));};var _elm_lang$html$Html_Attributes$property=_elm_lang$virtual_dom$VirtualDom$property;var _elm_lang$html$Html_Attributes$stringProperty=F2(function(name,string){return A2(_elm_lang$html$Html_Attributes$property,name,_elm_lang$core$Json_Encode$string(string));});var _elm_lang$html$Html_Attributes$class=function _elm_lang$html$Html_Attributes$class(name){return A2(_elm_lang$html$Html_Attributes$stringProperty,'className',name);};var _elm_lang$html$Html_Attributes$id=function _elm_lang$html$Html_Attributes$id(name){return A2(_elm_lang$html$Html_Attributes$stringProperty,'id',name);};var _elm_lang$html$Html_Attributes$title=function _elm_lang$html$Html_Attributes$title(name){return A2(_elm_lang$html$Html_Attributes$stringProperty,'title',name);};var _elm_lang$html$Html_Attributes$accesskey=function _elm_lang$html$Html_Attributes$accesskey($char){return A2(_elm_lang$html$Html_Attributes$stringProperty,'accessKey',_elm_lang$core$String$fromChar($char));};var _elm_lang$html$Html_Attributes$dir=function _elm_lang$html$Html_Attributes$dir(value){return A2(_elm_lang$html$Html_Attributes$stringProperty,'dir',value);};var _elm_lang$html$Html_Attributes$dropzone=function _elm_lang$html$Html_Attributes$dropzone(value){return A2(_elm_lang$html$Html_Attributes$stringProperty,'dropzone',value);};var _elm_lang$html$Html_Attributes$itemprop=function _elm_lang$html$Html_Attributes$itemprop(value){return A2(_elm_lang$html$Html_Attributes$stringProperty,'itemprop',value);};var _elm_lang$html$Html_Attributes$lang=function _elm_lang$html$Html_Attributes$lang(value){return A2(_elm_lang$html$Html_Attributes$stringProperty,'lang',value);};var _elm_lang$html$Html_Attributes$tabindex=function _elm_lang$html$Html_Attributes$tabindex(n){return A2(_elm_lang$html$Html_Attributes$stringProperty,'tabIndex',_elm_lang$core$Basics$toString(n));};var _elm_lang$html$Html_Attributes$charset=function _elm_lang$html$Html_Attributes$charset(value){return A2(_elm_lang$html$Html_Attributes$stringProperty,'charset',value);};var _elm_lang$html$Html_Attributes$content=function _elm_lang$html$Html_Attributes$content(value){return A2(_elm_lang$html$Html_Attributes$stringProperty,'content',value);};var _elm_lang$html$Html_Attributes$httpEquiv=function _elm_lang$html$Html_Attributes$httpEquiv(value){return A2(_elm_lang$html$Html_Attributes$stringProperty,'httpEquiv',value);};var _elm_lang$html$Html_Attributes$language=function _elm_lang$html$Html_Attributes$language(value){return A2(_elm_lang$html$Html_Attributes$stringProperty,'language',value);};var _elm_lang$html$Html_Attributes$src=function _elm_lang$html$Html_Attributes$src(value){return A2(_elm_lang$html$Html_Attributes$stringProperty,'src',value);};var _elm_lang$html$Html_Attributes$height=function _elm_lang$html$Html_Attributes$height(value){return A2(_elm_lang$html$Html_Attributes$stringProperty,'height',_elm_lang$core$Basics$toString(value));};var _elm_lang$html$Html_Attributes$width=function _elm_lang$html$Html_Attributes$width(value){return A2(_elm_lang$html$Html_Attributes$stringProperty,'width',_elm_lang$core$Basics$toString(value));};var _elm_lang$html$Html_Attributes$alt=function _elm_lang$html$Html_Attributes$alt(value){return A2(_elm_lang$html$Html_Attributes$stringProperty,'alt',value);};var _elm_lang$html$Html_Attributes$preload=function _elm_lang$html$Html_Attributes$preload(value){return A2(_elm_lang$html$Html_Attributes$stringProperty,'preload',value);};var _elm_lang$html$Html_Attributes$poster=function _elm_lang$html$Html_Attributes$poster(value){return A2(_elm_lang$html$Html_Attributes$stringProperty,'poster',value);};var _elm_lang$html$Html_Attributes$kind=function _elm_lang$html$Html_Attributes$kind(value){return A2(_elm_lang$html$Html_Attributes$stringProperty,'kind',value);};var _elm_lang$html$Html_Attributes$srclang=function _elm_lang$html$Html_Attributes$srclang(value){return A2(_elm_lang$html$Html_Attributes$stringProperty,'srclang',value);};var _elm_lang$html$Html_Attributes$sandbox=function _elm_lang$html$Html_Attributes$sandbox(value){return A2(_elm_lang$html$Html_Attributes$stringProperty,'sandbox',value);};var _elm_lang$html$Html_Attributes$srcdoc=function _elm_lang$html$Html_Attributes$srcdoc(value){return A2(_elm_lang$html$Html_Attributes$stringProperty,'srcdoc',value);};var _elm_lang$html$Html_Attributes$type$=function _elm_lang$html$Html_Attributes$type$(value){return A2(_elm_lang$html$Html_Attributes$stringProperty,'type',value);};var _elm_lang$html$Html_Attributes$value=function _elm_lang$html$Html_Attributes$value(value){return A2(_elm_lang$html$Html_Attributes$stringProperty,'value',value);};var _elm_lang$html$Html_Attributes$defaultValue=function _elm_lang$html$Html_Attributes$defaultValue(value){return A2(_elm_lang$html$Html_Attributes$stringProperty,'defaultValue',value);};var _elm_lang$html$Html_Attributes$placeholder=function _elm_lang$html$Html_Attributes$placeholder(value){return A2(_elm_lang$html$Html_Attributes$stringProperty,'placeholder',value);};var _elm_lang$html$Html_Attributes$accept=function _elm_lang$html$Html_Attributes$accept(value){return A2(_elm_lang$html$Html_Attributes$stringProperty,'accept',value);};var _elm_lang$html$Html_Attributes$acceptCharset=function _elm_lang$html$Html_Attributes$acceptCharset(value){return A2(_elm_lang$html$Html_Attributes$stringProperty,'acceptCharset',value);};var _elm_lang$html$Html_Attributes$action=function _elm_lang$html$Html_Attributes$action(value){return A2(_elm_lang$html$Html_Attributes$stringProperty,'action',value);};var _elm_lang$html$Html_Attributes$autocomplete=function _elm_lang$html$Html_Attributes$autocomplete(bool){return A2(_elm_lang$html$Html_Attributes$stringProperty,'autocomplete',bool?'on':'off');};var _elm_lang$html$Html_Attributes$autosave=function _elm_lang$html$Html_Attributes$autosave(value){return A2(_elm_lang$html$Html_Attributes$stringProperty,'autosave',value);};var _elm_lang$html$Html_Attributes$enctype=function _elm_lang$html$Html_Attributes$enctype(value){return A2(_elm_lang$html$Html_Attributes$stringProperty,'enctype',value);};var _elm_lang$html$Html_Attributes$formaction=function _elm_lang$html$Html_Attributes$formaction(value){return A2(_elm_lang$html$Html_Attributes$stringProperty,'formAction',value);};var _elm_lang$html$Html_Attributes$minlength=function _elm_lang$html$Html_Attributes$minlength(n){return A2(_elm_lang$html$Html_Attributes$stringProperty,'minLength',_elm_lang$core$Basics$toString(n));};var _elm_lang$html$Html_Attributes$method=function _elm_lang$html$Html_Attributes$method(value){return A2(_elm_lang$html$Html_Attributes$stringProperty,'method',value);};var _elm_lang$html$Html_Attributes$name=function _elm_lang$html$Html_Attributes$name(value){return A2(_elm_lang$html$Html_Attributes$stringProperty,'name',value);};var _elm_lang$html$Html_Attributes$pattern=function _elm_lang$html$Html_Attributes$pattern(value){return A2(_elm_lang$html$Html_Attributes$stringProperty,'pattern',value);};var _elm_lang$html$Html_Attributes$size=function _elm_lang$html$Html_Attributes$size(n){return A2(_elm_lang$html$Html_Attributes$stringProperty,'size',_elm_lang$core$Basics$toString(n));};var _elm_lang$html$Html_Attributes$for=function _elm_lang$html$Html_Attributes$for(value){return A2(_elm_lang$html$Html_Attributes$stringProperty,'htmlFor',value);};var _elm_lang$html$Html_Attributes$form=function _elm_lang$html$Html_Attributes$form(value){return A2(_elm_lang$html$Html_Attributes$stringProperty,'form',value);};var _elm_lang$html$Html_Attributes$max=function _elm_lang$html$Html_Attributes$max(value){return A2(_elm_lang$html$Html_Attributes$stringProperty,'max',value);};var _elm_lang$html$Html_Attributes$min=function _elm_lang$html$Html_Attributes$min(value){return A2(_elm_lang$html$Html_Attributes$stringProperty,'min',value);};var _elm_lang$html$Html_Attributes$step=function _elm_lang$html$Html_Attributes$step(n){return A2(_elm_lang$html$Html_Attributes$stringProperty,'step',n);};var _elm_lang$html$Html_Attributes$cols=function _elm_lang$html$Html_Attributes$cols(n){return A2(_elm_lang$html$Html_Attributes$stringProperty,'cols',_elm_lang$core$Basics$toString(n));};var _elm_lang$html$Html_Attributes$rows=function _elm_lang$html$Html_Attributes$rows(n){return A2(_elm_lang$html$Html_Attributes$stringProperty,'rows',_elm_lang$core$Basics$toString(n));};var _elm_lang$html$Html_Attributes$wrap=function _elm_lang$html$Html_Attributes$wrap(value){return A2(_elm_lang$html$Html_Attributes$stringProperty,'wrap',value);};var _elm_lang$html$Html_Attributes$usemap=function _elm_lang$html$Html_Attributes$usemap(value){return A2(_elm_lang$html$Html_Attributes$stringProperty,'useMap',value);};var _elm_lang$html$Html_Attributes$shape=function _elm_lang$html$Html_Attributes$shape(value){return A2(_elm_lang$html$Html_Attributes$stringProperty,'shape',value);};var _elm_lang$html$Html_Attributes$coords=function _elm_lang$html$Html_Attributes$coords(value){return A2(_elm_lang$html$Html_Attributes$stringProperty,'coords',value);};var _elm_lang$html$Html_Attributes$challenge=function _elm_lang$html$Html_Attributes$challenge(value){return A2(_elm_lang$html$Html_Attributes$stringProperty,'challenge',value);};var _elm_lang$html$Html_Attributes$keytype=function _elm_lang$html$Html_Attributes$keytype(value){return A2(_elm_lang$html$Html_Attributes$stringProperty,'keytype',value);};var _elm_lang$html$Html_Attributes$align=function _elm_lang$html$Html_Attributes$align(value){return A2(_elm_lang$html$Html_Attributes$stringProperty,'align',value);};var _elm_lang$html$Html_Attributes$cite=function _elm_lang$html$Html_Attributes$cite(value){return A2(_elm_lang$html$Html_Attributes$stringProperty,'cite',value);};var _elm_lang$html$Html_Attributes$href=function _elm_lang$html$Html_Attributes$href(value){return A2(_elm_lang$html$Html_Attributes$stringProperty,'href',value);};var _elm_lang$html$Html_Attributes$target=function _elm_lang$html$Html_Attributes$target(value){return A2(_elm_lang$html$Html_Attributes$stringProperty,'target',value);};var _elm_lang$html$Html_Attributes$downloadAs=function _elm_lang$html$Html_Attributes$downloadAs(value){return A2(_elm_lang$html$Html_Attributes$stringProperty,'download',value);};var _elm_lang$html$Html_Attributes$hreflang=function _elm_lang$html$Html_Attributes$hreflang(value){return A2(_elm_lang$html$Html_Attributes$stringProperty,'hreflang',value);};var _elm_lang$html$Html_Attributes$media=function _elm_lang$html$Html_Attributes$media(value){return A2(_elm_lang$html$Html_Attributes$stringProperty,'media',value);};var _elm_lang$html$Html_Attributes$ping=function _elm_lang$html$Html_Attributes$ping(value){return A2(_elm_lang$html$Html_Attributes$stringProperty,'ping',value);};var _elm_lang$html$Html_Attributes$rel=function _elm_lang$html$Html_Attributes$rel(value){return A2(_elm_lang$html$Html_Attributes$stringProperty,'rel',value);};var _elm_lang$html$Html_Attributes$start=function _elm_lang$html$Html_Attributes$start(n){return A2(_elm_lang$html$Html_Attributes$stringProperty,'start',_elm_lang$core$Basics$toString(n));};var _elm_lang$html$Html_Attributes$headers=function _elm_lang$html$Html_Attributes$headers(value){return A2(_elm_lang$html$Html_Attributes$stringProperty,'headers',value);};var _elm_lang$html$Html_Attributes$scope=function _elm_lang$html$Html_Attributes$scope(value){return A2(_elm_lang$html$Html_Attributes$stringProperty,'scope',value);};var _elm_lang$html$Html_Attributes$manifest=function _elm_lang$html$Html_Attributes$manifest(value){return A2(_elm_lang$html$Html_Attributes$stringProperty,'manifest',value);};var _elm_lang$html$Html_Attributes$boolProperty=F2(function(name,bool){return A2(_elm_lang$html$Html_Attributes$property,name,_elm_lang$core$Json_Encode$bool(bool));});var _elm_lang$html$Html_Attributes$hidden=function _elm_lang$html$Html_Attributes$hidden(bool){return A2(_elm_lang$html$Html_Attributes$boolProperty,'hidden',bool);};var _elm_lang$html$Html_Attributes$contenteditable=function _elm_lang$html$Html_Attributes$contenteditable(bool){return A2(_elm_lang$html$Html_Attributes$boolProperty,'contentEditable',bool);};var _elm_lang$html$Html_Attributes$spellcheck=function _elm_lang$html$Html_Attributes$spellcheck(bool){return A2(_elm_lang$html$Html_Attributes$boolProperty,'spellcheck',bool);};var _elm_lang$html$Html_Attributes$async=function _elm_lang$html$Html_Attributes$async(bool){return A2(_elm_lang$html$Html_Attributes$boolProperty,'async',bool);};var _elm_lang$html$Html_Attributes$defer=function _elm_lang$html$Html_Attributes$defer(bool){return A2(_elm_lang$html$Html_Attributes$boolProperty,'defer',bool);};var _elm_lang$html$Html_Attributes$scoped=function _elm_lang$html$Html_Attributes$scoped(bool){return A2(_elm_lang$html$Html_Attributes$boolProperty,'scoped',bool);};var _elm_lang$html$Html_Attributes$autoplay=function _elm_lang$html$Html_Attributes$autoplay(bool){return A2(_elm_lang$html$Html_Attributes$boolProperty,'autoplay',bool);};var _elm_lang$html$Html_Attributes$controls=function _elm_lang$html$Html_Attributes$controls(bool){return A2(_elm_lang$html$Html_Attributes$boolProperty,'controls',bool);};var _elm_lang$html$Html_Attributes$loop=function _elm_lang$html$Html_Attributes$loop(bool){return A2(_elm_lang$html$Html_Attributes$boolProperty,'loop',bool);};var _elm_lang$html$Html_Attributes$default=function _elm_lang$html$Html_Attributes$default(bool){return A2(_elm_lang$html$Html_Attributes$boolProperty,'default',bool);};var _elm_lang$html$Html_Attributes$seamless=function _elm_lang$html$Html_Attributes$seamless(bool){return A2(_elm_lang$html$Html_Attributes$boolProperty,'seamless',bool);};var _elm_lang$html$Html_Attributes$checked=function _elm_lang$html$Html_Attributes$checked(bool){return A2(_elm_lang$html$Html_Attributes$boolProperty,'checked',bool);};var _elm_lang$html$Html_Attributes$selected=function _elm_lang$html$Html_Attributes$selected(bool){return A2(_elm_lang$html$Html_Attributes$boolProperty,'selected',bool);};var _elm_lang$html$Html_Attributes$autofocus=function _elm_lang$html$Html_Attributes$autofocus(bool){return A2(_elm_lang$html$Html_Attributes$boolProperty,'autofocus',bool);};var _elm_lang$html$Html_Attributes$disabled=function _elm_lang$html$Html_Attributes$disabled(bool){return A2(_elm_lang$html$Html_Attributes$boolProperty,'disabled',bool);};var _elm_lang$html$Html_Attributes$multiple=function _elm_lang$html$Html_Attributes$multiple(bool){return A2(_elm_lang$html$Html_Attributes$boolProperty,'multiple',bool);};var _elm_lang$html$Html_Attributes$novalidate=function _elm_lang$html$Html_Attributes$novalidate(bool){return A2(_elm_lang$html$Html_Attributes$boolProperty,'noValidate',bool);};var _elm_lang$html$Html_Attributes$readonly=function _elm_lang$html$Html_Attributes$readonly(bool){return A2(_elm_lang$html$Html_Attributes$boolProperty,'readOnly',bool);};var _elm_lang$html$Html_Attributes$required=function _elm_lang$html$Html_Attributes$required(bool){return A2(_elm_lang$html$Html_Attributes$boolProperty,'required',bool);};var _elm_lang$html$Html_Attributes$ismap=function _elm_lang$html$Html_Attributes$ismap(value){return A2(_elm_lang$html$Html_Attributes$boolProperty,'isMap',value);};var _elm_lang$html$Html_Attributes$download=function _elm_lang$html$Html_Attributes$download(bool){return A2(_elm_lang$html$Html_Attributes$boolProperty,'download',bool);};var _elm_lang$html$Html_Attributes$reversed=function _elm_lang$html$Html_Attributes$reversed(bool){return A2(_elm_lang$html$Html_Attributes$boolProperty,'reversed',bool);};var _elm_lang$html$Html_Attributes$classList=function _elm_lang$html$Html_Attributes$classList(list){return _elm_lang$html$Html_Attributes$class(A2(_elm_lang$core$String$join,' ',A2(_elm_lang$core$List$map,_elm_lang$core$Basics$fst,A2(_elm_lang$core$List$filter,_elm_lang$core$Basics$snd,list))));};var _elm_lang$html$Html_Attributes$style=_elm_lang$virtual_dom$VirtualDom$style;var _Fresheyeball$elm_font_awesome$FontAwesome_Util$class=function _Fresheyeball$elm_font_awesome$FontAwesome_Util$class(s){return A2(_elm_lang$core$Basics_ops['++'],'fa fa-',s);};var _Fresheyeball$elm_font_awesome$FontAwesome_Util$icon=function _Fresheyeball$elm_font_awesome$FontAwesome_Util$icon(s){return A2(_elm_lang$html$Html$i,_elm_lang$core$Native_List.fromArray([_elm_lang$html$Html_Attributes$class(_Fresheyeball$elm_font_awesome$FontAwesome_Util$class(s))]),_elm_lang$core$Native_List.fromArray([]));};var _Fresheyeball$elm_font_awesome$FontAwesome_Web_Class$wrench='wrench';var _Fresheyeball$elm_font_awesome$FontAwesome_Web_Class$wifi='wifi';var _Fresheyeball$elm_font_awesome$FontAwesome_Web_Class$wheelchair_alt='wheelchair-alt';var _Fresheyeball$elm_font_awesome$FontAwesome_Web_Class$wheelchair='wheelchair';var _Fresheyeball$elm_font_awesome$FontAwesome_Web_Class$warning='warning';var _Fresheyeball$elm_font_awesome$FontAwesome_Web_Class$volume_up='volume-up';var _Fresheyeball$elm_font_awesome$FontAwesome_Web_Class$volume_off='volume-off';var _Fresheyeball$elm_font_awesome$FontAwesome_Web_Class$volume_down='volume-down';var _Fresheyeball$elm_font_awesome$FontAwesome_Web_Class$volume_control_phone='volume-control-phone';var _Fresheyeball$elm_font_awesome$FontAwesome_Web_Class$video_camera='video-camera';var _Fresheyeball$elm_font_awesome$FontAwesome_Web_Class$users='users';var _Fresheyeball$elm_font_awesome$FontAwesome_Web_Class$user_times='user-times';var _Fresheyeball$elm_font_awesome$FontAwesome_Web_Class$user_secret='user-secret';var _Fresheyeball$elm_font_awesome$FontAwesome_Web_Class$user_plus='user-plus';var _Fresheyeball$elm_font_awesome$FontAwesome_Web_Class$user='user';var _Fresheyeball$elm_font_awesome$FontAwesome_Web_Class$upload='upload';var _Fresheyeball$elm_font_awesome$FontAwesome_Web_Class$unsorted='unsorted';var _Fresheyeball$elm_font_awesome$FontAwesome_Web_Class$unlock_alt='unlock-alt';var _Fresheyeball$elm_font_awesome$FontAwesome_Web_Class$unlock='unlock';var _Fresheyeball$elm_font_awesome$FontAwesome_Web_Class$university='university';var _Fresheyeball$elm_font_awesome$FontAwesome_Web_Class$universal_access='universal-access';var _Fresheyeball$elm_font_awesome$FontAwesome_Web_Class$umbrella='umbrella';var _Fresheyeball$elm_font_awesome$FontAwesome_Web_Class$tv='tv';var _Fresheyeball$elm_font_awesome$FontAwesome_Web_Class$tty='tty';var _Fresheyeball$elm_font_awesome$FontAwesome_Web_Class$truck='truck';var _Fresheyeball$elm_font_awesome$FontAwesome_Web_Class$trophy='trophy';var _Fresheyeball$elm_font_awesome$FontAwesome_Web_Class$tree='tree';var _Fresheyeball$elm_font_awesome$FontAwesome_Web_Class$trash_o='trash-o';var _Fresheyeball$elm_font_awesome$FontAwesome_Web_Class$trash='trash';var _Fresheyeball$elm_font_awesome$FontAwesome_Web_Class$trademark='trademark';var _Fresheyeball$elm_font_awesome$FontAwesome_Web_Class$toggle_up='toggle-up';var _Fresheyeball$elm_font_awesome$FontAwesome_Web_Class$toggle_right='toggle-right';var _Fresheyeball$elm_font_awesome$FontAwesome_Web_Class$toggle_on='toggle-on
spinner='spinner';var _Fresheyeball$elm_font_awesome$FontAwesome_Web_Class$space_shuttle='space-shuttle';var _Fresheyeball$elm_font_awesome$FontAwesome_Web_Class$sort_up='sort-up';var _Fresheyeball$elm_font_awesome$FontAwesome_Web_Class$sort_numeric_desc='sort-numeric-desc';var _Fresheyeball$elm_font_awesome$FontAwesome_Web_Class$sort_numeric_asc='sort-numeric-asc';var _Fresheyeball$elm_font_awesome$FontAwesome_Web_Class$sort_down='sort-down';var _Fresheyeball$elm_font_awesome$FontAwesome_Web_Class$sort_desc='sort-desc';var _Fresheyeball$elm_font_awesome$FontAwesome_Web_Class$sort_asc='sort-asc';var _Fresheyeball$elm_font_awesome$FontAwesome_Web_Class$sort_amount_desc='sort-amount-desc';var _Fresheyeball$elm_font_awesome$FontAwesome_Web_Class$sort_amount_asc='sort-amount-asc';var _Fresheyeball$elm_font_awesome$FontAwesome_Web_Class$sort_alpha_desc='sort-alpha-desc';var _Fresheyeball$elm_font_awesome$FontAwesome_Web_Class$sort_alpha_asc='sort-alpha-asc';var _Fresheyeball$elm_font_awesome$FontAwesome_Web_Class$sort='sort';var _Fresheyeball$elm_font_awesome$FontAwesome_Web_Class$soccer_ball_o='soccer-ball-o';var _Fresheyeball$elm_font_awesome$FontAwesome_Web_Class$smile_o='smile-o';var _Fresheyeball$elm_font_awesome$FontAwesome_Web_Class$sliders='sliders';var _Fresheyeball$elm_font_awesome$FontAwesome_Web_Class$sitemap='sitemap';var _Fresheyeball$elm_font_awesome$FontAwesome_Web_Class$signing='signing';var _Fresheyeball$elm_font_awesome$FontAwesome_Web_Class$signal='signal';var _Fresheyeball$elm_font_awesome$FontAwesome_Web_Class$sign_out='sign-out';var _Fresheyeball$elm_font_awesome$FontAwesome_Web_Class$sign_language='sign-language';var _Fresheyeball$elm_font_awesome$FontAwesome_Web_Class$sign_in='sign-in';var _Fresheyeball$elm_font_awesome$FontAwesome_Web_Class$shopping_cart='shopping-cart';var _Fresheyeball$elm_font_awesome$FontAwesome_Web_Class$shopping_basket='shopping-basket';var _Fresheyeball$elm_font_awesome$FontAwesome_Web_Class$shopping_bag='shopping-bag';var _Fresheyeball$elm_font_awesome$FontAwesome_Web_Class$ship='ship';var _Fresheyeball$elm_font_awesome$FontAwesome_Web_Class$shield='shield';var _Fresheyeball$elm_font_awesome$FontAwesome_Web_Class$share_square_o='share-square-o';var _Fresheyeball$elm_font_awesome$FontAwesome_Web_Class$share_square='share-square';var _Fresheyeball$elm_font_awesome$FontAwesome_Web_Class$share_alt_square='share-alt-square';var _Fresheyeball$elm_font_awesome$FontAwesome_Web_Class$share_alt='share-alt';var _Fresheyeball$elm_font_awesome$FontAwesome_Web_Class$share='share';var _Fresheyeball$elm_font_awesome$FontAwesome_Web_Class$server='server';var _Fresheyeball$elm_font_awesome$FontAwesome_Web_Class$send_o='send-o';var _Fresheyeball$elm_font_awesome$FontAwesome_Web_Class$send='send';var _Fresheyeball$elm_font_awesome$FontAwesome_Web_Class$search_plus='search-plus';var _Fresheyeball$elm_
yeball$elm_font_awesome$FontAwesome_Web$sort_numeric_desc=_Fresheyeball$elm_font_awesome$FontAwesome_Util$icon(_Fresheyeball$elm_font_awesome$FontAwesome_Web_Class$sort_numeric_desc);var _Fresheyeball$elm_font_awesome$FontAwesome_Web$sort_numeric_asc=_Fresheyeball$elm_font_awesome$FontAwesome_Util$icon(_Fresheyeball$elm_font_awesome$FontAwesome_Web_Class$sort_numeric_asc);var _Fresheyeball$elm_font_awesome$FontAwesome_Web$sort_down=_Fresheyeball$elm_font_awesome$FontAwesome_Util$icon(_Fresheyeball$elm_font_awesome$FontAwesome_Web_Class$sort_down);var _Fresheyeball$elm_font_awesome$FontAwesome_Web$sort_desc=_Fresheyeball$elm_font_awesome$FontAwesome_Util$icon(_Fresheyeball$elm_font_awesome$FontAwesome_Web_Class$sort_desc);var _Fresheyeball$elm_font_awesome$FontAwesome_Web$sort_asc=_Fresheyeball$elm_font_awesome$FontAwesome_Util$icon(_Fresheyeball$elm_font_awesome$FontAwesome_Web_Class$sort_asc);var _Fresheyeball$elm_font_awesome$FontAwesome_Web$sort_amount_desc=_Fresheyeball$elm_font_awesome$FontAwesome_Util$icon(_Fresheyeball$elm_font_awesome$FontAwesome_Web_Class$sort_amount_desc);var _Fresheyeball$elm_font_awesome$FontAwesome_Web$sort_amount_asc=_Fresheyeball$elm_font_awesome$FontAwesome_Util$icon(_Fresheyeball$elm_font_awesome$FontAwesome_Web_Class$sort_amount_asc);var _Fresheyeball$elm_font_awesome$FontAwesome_Web$sort_alpha_desc=_Fresheyeball$elm_font_awesome$FontAwesome_Util$icon(_Fresheyeball$elm_font_awesome$FontAwesome_Web_Class$sort_alpha_desc);var _Fresheyeball$elm_font_awesome$FontAwesome_Web$sort_alpha_asc=_Fresheyeball$elm_font_awesome$FontAwesome_Util$icon(_Fresheyeball$elm_font_awesome$FontAwesome_Web_Class$sort_alpha_asc);var _Fresheyeball$elm_font_awesome$FontAwesome_Web$sort=_Fresheyeball$elm_font_awesome$FontAwesome_Util$icon(_Fresheyeball$elm_font_awesome$FontAwesome_Web_Class$sort);var _Fresheyeball$elm_font_awesome$FontAwesome_Web$soccer_ball_o=_Fresheyeball$elm_font_awesome$FontAwesome_Util$icon(_Fresheyeball$elm_font_awesome$FontAwesome_Web_Class$soccer_ball_o);var _Fresheyeball$elm_font_awesome$FontAwesome_Web$smile_o=_Fresheyeball$elm_font_awesome$FontAwesome_Util$icon(_Fresheyeball$elm_font_awesome$FontAwesome_Web_Class$smile_o);var _Fresheyeball$elm_font_awesome$FontAwesome_Web$sliders=_Fresheyeball$elm_font_awesome$FontAwesome_Util$icon(_Fresheyeball$elm_font_awesome$FontAwesome_Web_Class$sliders);var _Fresheyeball$elm_font_awesome$FontAwesome_Web$sitemap=_Fresheyeball$elm_font_awesome$FontAwesome_Util$icon(_Fresheyeball$elm_font_awesome$FontAwesome_Web_Class$sitemap);var _Fresheyeball$elm_font_awesome$FontAwesome_Web$signing=_Fresheyeball$elm_font_awesome$FontAwesome_Util$icon(_Fres
$american_sign_language_interpreting=_Fresheyeball$elm_font_awesome$FontAwesome_Util$icon(_Fresheyeball$elm_font_awesome$FontAwesome_Web_Class$american_sign_language_interpreting);var _Fresheyeball$elm_font_awesome$FontAwesome_Web$adjust=_Fresheyeball$elm_font_awesome$FontAwesome_Util$icon(_Fresheyeball$elm_font_awesome$FontAwesome_Web_Class$adjust);var _JeremyBellows$elm_bootstrapify$Bootstrap_Buttons$getButtonModifierAttribute=function _JeremyBellows$elm_bootstrapify$Bootstrap_Buttons$getButtonModifierAttribute(btnModifier){var _p0=btnModifier;return _elm_lang$core$Native_List.fromArray([A2(_elm_lang$html$Html_Attributes$attribute,'data-toggle','collapse'),A2(_elm_lang$html$Html_Attributes$attribute,'data-target',_p0._0)]);};var _JeremyBellows$elm_bootstrapify$Bootstrap_Buttons$getButtonModifierClass=function _JeremyBellows$elm_bootstrapify$Bootstrap_Buttons$getButtonModifierClass(btnModifier){var _p1=btnModifier;switch(_p1.ctor){case'BtnLarge':return'btn-lg';case'BtnBlock':return'btn-block';case'BtnSmall':return'btn-sm';case'BtnExtraSmall':return'btn-xs';default:return'navbar-btn';}};var _JeremyBellows$elm_bootstrapify$Bootstrap_Buttons$btn=F5(function(btnOption,btnSizeModifiers,btnModifiers,attributes,htmlList){var buttonOptionClass=function(){var _p2=btnOption;switch(_p2.ctor){case'BtnDefault':return'btn-default';case'BtnPrimary':return'btn-primary';case'BtnSuccess':return'btn-success';case'BtnInfo':return'btn-info';case'BtnDanger':return'btn-danger';default:return'btn-warning';}}();var buttonModifierAttributes=_elm_lang$core$List$concat(A2(_elm_lang$core$List$map,_JeremyBellows$elm_bootstrapify$Bootstrap_Buttons$getButtonModifierAttribute,btnModifiers));var btnModifierAttributes=A2(_elm_lang$core$Basics_ops['++'],buttonModifierAttributes,attributes);var buttonModifierClasses=_elm_lang$core$String$concat(A2(_elm_lang$core$List$map,function($class){return A2(_elm_lang$core$Basics_ops['++'],$class,' ');},A2(_elm_lang$core$List$map,_JeremyBellows$elm_bootstrapify$Bootstrap_Buttons$getButtonModifierClass,btnSizeModifiers)));var classes=A2(_elm_lang$core$Basics_ops['++'],'btn ',A2(_elm_lang$core$Basics_ops['++'],buttonOptionClass,A2(_elm_lang$core$Basics_ops['++'],' ',buttonModifierClasses)));var newAttributes=A2(_elm_lang$core$List_ops['::'],_elm_lang$html$Html_Attributes$class(classes),btnModifierAttributes);return A2(_elm_lang$html$Html$button,newAttributes,htmlList);});var _JeremyBellows$elm_bootstrapify$Bootstrap_Buttons$BtnDanger={ctor:'BtnDanger'};var _JeremyBellows$elm_bootstrapify$Bootstrap_Buttons$BtnInfo={ctor:'BtnInfo'};var _JeremyBellows$elm_bootstrapify$Bootstrap_Buttons$BtnWarning={ctor:'BtnWarning'};var _JeremyBellows$elm_bootstrapify$Bootstrap_Buttons$BtnSuccess={ctor:'BtnSuccess'};var _JeremyBellows$elm_bootstrapify$Bootstrap_Buttons$BtnPrimary={ctor:'BtnPrimary'};var _JeremyBellows$elm_bootstrapify$Bootstrap_Buttons$BtnDefault={ctor:'BtnDefault'};var _JeremyBellows$elm_bootstrapify$Bootstrap_Buttons$NavbarBtn={ctor:'NavbarBtn'};var _JeremyBellows$elm_bootstrapify$Bootstrap_Buttons$BtnExtraSmall={ctor:'BtnExtraSmall'};var _JeremyBellows$elm_bootstrapify$Bootstrap_Buttons$BtnSmall={ctor:'BtnSmall'};var _JeremyBellows$elm_bootstrapify$Bootstrap_Buttons$BtnBlock={ctor:'BtnBlock'};var _JeremyBellows$elm_bootstrapify$Bootstrap_Buttons$BtnLarge={ctor:'BtnLarge'};var _JeremyBellows$elm_bootstrapify$Bootstrap_Buttons$BtnCollapse=function _JeremyBellows$elm_bootstrapify$Bootstrap_Buttons$BtnCollapse(a){return{ctor:'BtnCollapse',_0:a};};var _elm_lang$core$Task$onError=_elm_lang$core$Native_Scheduler.onError;var _elm_lang$core$Task$andThen=_elm_lang$core$Native_Scheduler.andThen;var _elm_lang$core$Task$spawnCmd=F2(function(router,_p0){var _p1=_p0;return _elm_lang$core$Native_Scheduler.spawn(A2(_elm_lang$core$Task$andThen,_p1._0,_elm_lang$core$Platform$sendToApp(router)));});var _elm_lang$core$Task$fail=_elm_lang$core$Native_Scheduler.fail;var _elm_lang$core$Task$mapError=F2(function(f,task){return A2(_elm_lang$core$Task$onError,task,function(err){return _elm_lang$core$Task$fail(f(err));});});var _elm_lang$core$Task$succeed=_elm_lang$core$Native_Scheduler.succeed;var _elm_lang$core$Task$map=F2(function(func,taskA){return A2(_elm_lang$core$Task$andThen,taskA,function(a){return _elm_lang$core$Task$succeed(func(a));});});var _elm_lang$core$Task$map2=F3(function(func,taskA,taskB){return A2(_elm_lang$core$Task$andThen,taskA,function(a){return A2(_elm_lang$core$Task$andThen,taskB,function(b){return _elm_lang$core$Task$succeed(A2(func,a,b));});});});var _elm_lang$core$Task$map3=F4(function(func,taskA,taskB,taskC){return A2(_elm_lang$core$Task$andThen,taskA,function(a){return A2(_elm_lang$core$Task$andThen,taskB,function(b){return A2(_elm_lang$core$Task$andThen,taskC,function(c){return _elm_lang$core$Task$succeed(A3(func,a,b,c));});});});});var _elm_lang$core$Task$map4=F5(function(func,taskA,taskB,taskC,taskD){return A2(_elm_lang$core$Task$andThen,taskA,function(a){return A2(_elm_lang$core$Task$andThen,taskB,function(b){return A2(_elm_lang$core$Task$andThen,taskC,function(c){return A2(_elm_lang$core$Task$andThen,taskD,function(d){return _elm_lang$core$Task$succeed(A4(func,a,b,c,d));});});});});});var _elm_lang$core$Task$map5=F6(function(func,taskA,taskB,taskC,taskD,taskE){return A2(_elm_lang$core$Task$andThen,taskA,function(a){return A2(_elm_lang$core$Task$andThen,taskB,function(b){return A2(_elm_lang$core$Task$andThen,taskC,function(c){return A2(_elm_lang$core$Task$andThen,taskD,function(d){return A2(_elm_lang$core$Task$andThen,taskE,function(e){return _elm_lang$core$Task$succeed(A5(func,a,b,c,d,e));});});});});});});var _elm_lang$core$Task$andMap=F2(function(taskFunc,taskValue){return A2(_elm_lang$core$Task$andThen,taskFunc,function(func){return A2(_elm_lang$core$Task$andThen,taskValue,function(value){return _elm_lang$core$Task$succeed(func(value));});});});var _elm_lang$core$Task$sequence=function _elm_lang$core$Task$sequence(tasks){var _p2=tasks;if(_p2.ctor==='[]'){return _elm_lang$core$Task$succeed(_elm_lang$core$Native_List.fromArray([]));}else{return A3(_elm_lang$core$Task$map2,F2(function(x,y){return A2(_elm_lang$core$List_ops['::'],x,y);}),_p2._0,_elm_lang$core$Task$sequence(_p2._1));}};var _elm_lang$core$Task$onEffects=F3(function(router,commands,state){return A2(_elm_lang$core$Task$map,function(_p3){return{ctor:'_Tuple0'};},_elm_lang$core$Task$sequence(A2(_elm_lang$core$List$map,_elm_lang$core$Task$spawnCmd(router),commands)));});var _elm_lang$core$Task$toMaybe=function _elm_lang$core$Task$toMaybe(task){return A2(_elm_lang$core$Task$onError,A2(_elm_lang$core$Task$map,_elm_lang$core$Maybe$Just,task),function(_p4){return _elm_lang$core$Task$succeed(_elm_lang$core$Maybe$Nothing);});};var _elm_lang$core$Task$fromMaybe=F2(function($default,maybe){var _p5=maybe;if(_p5.ctor==='Just'){return _elm_lang$core$Task$succeed(_p5._0);}else{return _elm_lang$core$Task$fail($default);}});var _elm_lang$core$Task$toResult=function _elm_lang$core$Task$toResult(task){return A2(_elm_lang$core$Task$onError,A2(_elm_lang$core$Task$map,_elm_lang$core$Result$Ok,task),function(msg){return _elm_lang$core$Task$succeed(_elm_lang$core$Result$Err(msg));});};var _elm_lang$core$Task$fromResult=function _elm_lang$core$Task$fromResult(result){var _p6=result;if(_p6.ctor==='Ok'){return _elm_lang$core$Task$succeed(_p6._0);}else{return _elm_lang$core$Task$fail(_p6._0);}};var _elm_lang$core$Task$init=_elm_lang$core$Task$succeed({ctor:'_Tuple0'});var _elm_lang$core$Task$onSelfMsg=F3(function(_p9,_p8,_p7){return _elm_lang$core$Task$succeed({ctor:'_Tuple0'});});var _elm_lang$core$Task$command=_elm_lang$core$Native_Platform.leaf('Task');var _elm_lang$core$Task$T=function _elm_lang$core$Task$T(a){return{ctor:'T',_0:a};};var _elm_lang$core$Task$perform=F3(function(onFail,onSuccess,task){return _elm_lang$core$Task$command(_elm_lang$core$Task$T(A2(_elm_lang$core$Task$onError,A2(_elm_lang$core$Task$map,onSuccess,task),function(x){return _elm_lang$core$Task$succeed(onFail(x));})));});var _elm_lang$core$Task$cmdMap=F2(function(tagger,_p10){var _p11=_p10;return _elm_lang$core$Task$T(A2(_elm_lang$core$Task$map,tagger,_p11._0));});_elm_lang$core$Native_Platform.effectManagers['Task']={pkg:'elm-lang/core',init:_elm_lang$core$Task$init,onEffects:_elm_lang$core$Task$onEffects,onSelfMsg:_elm_lang$core$Task$onSelfMsg,tag:'cmd',cmdMap:_elm_lang$core$Task$cmdMap};//import Native.Scheduler //
var _elm_lang$core$Native_Time=function(){var now=_elm_lang$core$Native_Scheduler.nativeBinding(function(callback){callback(_elm_lang$core$Native_Scheduler.succeed(Date.now()));});function setInterval_(interval,task){return _elm_lang$core$Native_Scheduler.nativeBinding(function(callback){var id=setInterval(function(){_elm_lang$core$Native_Scheduler.rawSpawn(task);},interval);return function(){clearInterval(id);};});}return{now:now,setInterval_:F2(setInterval_)};}();var _elm_lang$core$Time$setInterval=_elm_lang$core$Native_Time.setInterval_;var _elm_lang$core$Time$spawnHelp=F3(function(router,intervals,processes){var _p0=intervals;if(_p0.ctor==='[]'){return _elm_lang$core$Task$succeed(processes);}else{var _p1=_p0._0;return A2(_elm_lang$core$Task$andThen,_elm_lang$core$Native_Scheduler.spawn(A2(_elm_lang$core$Time$setInterval,_p1,A2(_elm_lang$core$Platform$sendToSelf,router,_p1))),function(id){return A3(_elm_lang$core$Time$spawnHelp,router,_p0._1,A3(_elm_lang$core$Dict$insert,_p1,id,processes));});}});var _elm_lang$core$Time$addMySub=F2(function(_p2,state){var _p3=_p2;var _p6=_p3._1;var _p5=_p3._0;var _p4=A2(_elm_lang$core$Dict$get,_p5,state);if(_p4.ctor==='Nothing'){return A3(_elm_lang$core$Dict$insert,_p5,_elm_lang$core$Native_List.fromArray([_p6]),state);}else{return A3(_elm_lang$core$Dict$insert,_p5,A2(_elm_lang$core$List_ops['::'],_p6,_p4._0),state);}});var _elm_lang$core$Time$inMilliseconds=function _elm_lang$core$Time$inMilliseconds(t){return t;};var _elm_lang$core$Time$millisecond=1;var _elm_lang$core$Time$second=1000*_elm_lang$core$Time$millisecond;var _elm_lang$core$Time$minute=60*_elm_lang$core$Time$second;var _elm_lang$core$Time$hour=60*_elm_lang$core$Time$minute;var _elm_lang$core$Time$inHours=function _elm_lang$core$Time$inHours(t){return t/_elm_lang$core$Time$hour;};var _elm_lang$core$Time$inMinutes=function _elm_lang$core$Time$inMinutes(t){return t/_elm_lang$core$Time$minute;};var _elm_lang$core$Time$inSeconds=function _elm_lang$core$Time$inSeconds(t){return t/_elm_lang$core$Time$second;};var _elm_lang$core$Time$now=_elm_lang$core$Native_Time.now;var _elm_lang$core$Time$onSelfMsg=F3(function(router,interval,state){var _p7=A2(_elm_lang$core$Dict$get,interval,state.taggers);if(_p7.ctor==='Nothing'){return _elm_lang$core$Task$succeed(state);}else{return A2(_elm_lang$core$Task$andThen,_elm_lang$core$Time$now,function(time){return A2(_elm_lang$core$Task$andThen,_elm_lang$core$Task$sequence(A2(_elm_lang$core$List$map,function(tagger){return A2(_elm_lang$core$Platform$sendToApp,router,tagger(time));},_p7._0)),function(_p8){return _elm_lang$core$Task$succeed(state);});});}});var _elm_lang$core$Time$subscription=_elm_lang$core$Native_Platform.leaf('Time');var _elm_lang$core$Time$State=F2(function(a,b){return{taggers:a,processes:b};});var _elm_lang$core$Time$init=_elm_lang$core$Task$succeed(A2(_elm_lang$core$Time$State,_elm_lang$core$Dict$empty,_elm_lang$core$Dict$empty));var _elm_lang$core$Time$onEffects=F3(function(router,subs,_p9){var _p10=_p9;var rightStep=F3(function(_p12,id,_p11){var _p13=_p11;return{ctor:'_Tuple3',_0:_p13._0,_1:_p13._1,_2:A2(_elm_lang$core$Task$andThen,_elm_lang$core$Native_Scheduler.kill(id),function(_p14){return _p13._2;})};});var bothStep=F4(function(interval,taggers,id,_p15){var _p16=_p15;return{ctor:'_Tuple3',_0:_p16._0,_1:A3(_elm_lang$core$Dict$insert,interval,id,_p16._1),_2:_p16._2};});var leftStep=F3(function(interval,taggers,_p17){var _p18=_p17;return{ctor:'_Tuple3',_0:A2(_elm_lang$core$List_ops['::'],interval,_p18._0),_1:_p18._1,_2:_p18._2};});var newTaggers=A3(_elm_lang$core$List$foldl,_elm_lang$core$Time$addMySub,_elm_lang$core$Dict$empty,subs);var _p19=A6(_elm_lang$core$Dict$merge,leftStep,bothStep,rightStep,newTaggers,_p10.processes,{ctor:'_Tuple3',_0:_elm_lang$core$Native_List.fromArray([]),_1:_elm_lang$core$Dict$empty,_2:_elm_lang$core$Task$succeed({ctor:'_Tuple0'})});var spawnList=_p19._0;var existingDict=_p19._1;var killTask=_p19._2;return A2(_elm_lang$core$Task$andThen,killTask,function(_p20){return A2(_elm_lang$core$Task$andThen,A3(_elm_lang$core$Time$spawnHelp,router,spawnList,existingDict),function(newProcesses){return _elm_lang$core$Task$succeed(A2(_elm_lang$core$Time$State,newTaggers,newProcesses));});});});var _elm_lang$core$Time$Every=F2(function(a,b){return{ctor:'Every',_0:a,_1:b};});var _elm_lang$core$Time$every=F2(function(interval,tagger){return _elm_lang$core$Time$subscription(A2(_elm_lang$core$Time$Every,interval,tagger));});var _elm_lang$core$Time$subMap=F2(function(f,_p21){var _p22=_p21;return A2(_elm_lang$core$Time$Every,_p22._0,function(_p23){return f(_p22._1(_p23));});});_elm_lang$core$Native_Platform.effectManagers['Time']={pkg:'elm-lang/core',init:_elm_lang$core$Time$init,onEffects:_elm_lang$core$Time$onEffects,onSelfMsg:_elm_lang$core$Time$onSelfMsg,tag:'sub',subMap:_elm_lang$core$Time$subMap};var _elm_lang$core$Process$kill=_elm_lang$core$Native_Scheduler.kill;var _elm_lang$core$Process$sleep=_elm_lang$core$Native_Scheduler.sleep;var _elm_lang$core$Process$spawn=_elm_lang$core$Native_Scheduler.spawn;var _elm_lang$html$Html_App$programWithFlags=_elm_lang$virtual_dom$VirtualDom$programWithFlags;var _elm_lang$html$Html_App$program=function _elm_lang$html$Html_App$program(app){return _elm_lang$html$Html_App$programWithFlags(_elm_lang$core$Native_Utils.update(app,{init:function init(_p0){return app.init;}}));};var _elm_lang$html$Html_App$beginnerProgram=function _elm_lang$html$Html_App$beginnerProgram(_p1){var _p2=_p1;return _elm_lang$html$Html_App$programWithFlags({init:function init(_p3){return A2(_elm_lang$core$Platform_Cmd_ops['!'],_p2.model,_elm_lang$core$Native_List.fromArray([]));},update:F2(function(msg,model){return A2(_elm_lang$core$Platform_Cmd_ops['!'],A2(_p2.update,msg,model),_elm_lang$core$Native_List.fromArray([]));}),view:_p2.view,subscriptions:function subscriptions(_p4){return _elm_lang$core$Platform_Sub$none;}});};var _elm_lang$html$Html_App$map=_elm_lang$virtual_dom$VirtualDom$map;var _elm_lang$html$Html_Events$keyCode=A2(_elm_lang$core$Json_Decode_ops[':='],'keyCode',_elm_lang$core$Json_Decode$int);var _elm_lang$html$Html_Events$targetChecked=A2(_elm_lang$core$Json_Decode$at,_elm_lang$core$Native_List.fromArray(['target','checked']),_elm_lang$core$Json_Decode$bool);var _elm_lang$html$Html_Events$targetValue=A2(_elm_lang$core$Json_Decode$at,_elm_lang$core$Native_List.fromArray(['target','value']),_elm_lang$core$Json_Decode$string);var _elm_lang$html$Html_Events$defaultOptions=_elm_lang$virtual_dom$VirtualDom$defaultOptions;var _elm_lang$html$Html_Events$onWithOptions=_elm_lang$virtual_dom$VirtualDom$onWithOptions;var _elm_lang$html$Html_Events$on=_elm_lang$virtual_dom$VirtualDom$on;var _elm_lang$html$Html_Events$onFocus=function _elm_lang$html$Html_Events$onFocus(msg){return A2(_elm_lang$html$Html_Events$on,'focus',_elm_lang$core$Json_Decode$succeed(msg));};var _elm_lang$html$Html_Events$onBlur=function _elm_lang$html$Html_Events$onBlur(msg){return A2(_elm_lang$html$Html_Events$on,'blur',_elm_lang$core$Json_Decode$succeed(msg));};var _elm_lang$html$Html_Events$onSubmitOptions=_elm_lang$core$Native_Utils.update(_elm_lang$html$Html_Events$defaultOptions,{preventDefault:true});var _elm_lang$html$Html_Events$onSubmit=function _elm_lang$html$Html_Events$onSubmit(msg){return A3(_elm_lang$html$Html_Events$onWithOptions,'submit',_elm_lang$html$Html_Events$onSubmitOptions,_elm_lang$core$Json_Decode$succeed(msg));};var _elm_lang$html$Html_Events$onCheck=function _elm_lang$html$Html_Events$onCheck(tagger){return A2(_elm_lang$html$Html_Events$on,'change',A2(_elm_lang$core$Json_Decode$map,tagger,_elm_lang$html$Html_Events$targetChecked));};var _elm_lang$html$Html_Events$onInput=function _elm_lang$html$Html_Events$onInput(tagger){return A2(_elm_lang$html$Html_Events$on,'input',A2(_elm_lang$core$Json_Decode$map,tagger,_elm_lang$html$Html_Events$targetValue));};var _elm_lang$html$Html_Events$onMouseOut=function _elm_lang$html$Html_Events$onMouseOut(msg){return A2(_elm_lang$html$Html_Events$on,'mouseout',_elm_lang$core$Json_Decode$succeed(msg));};var _elm_lang$html$Html_Events$onMouseOver=function _elm_lang$html$Html_Events$onMouseOver(msg){return A2(_elm_lang$html$Html_Events$on,'mouseover',_elm_lang$core$Json_Decode$succeed(msg));};var _elm_lang$html$Html_Events$onMouseLeave=function _elm_lang$html$Html_Events$onMouseLeave(msg){return A2(_elm_lang$html$Html_Events$on,'mouseleave',_elm_lang$core$Json_Decode$succeed(msg));};var _elm_lang$html$Html_Events$onMouseEnter=function _elm_lang$html$Html_Events$onMouseEnter(msg){return A2(_elm_lang$html$Html_Events$on,'mouseenter',_elm_lang$core$Json_Decode$succeed(msg));};var _elm_lang$html$Html_Events$onMouseUp=function _elm_lang$html$Html_Events$onMouseUp(msg){return A2(_elm_lang$html$Html_Events$on,'mouseup',_elm_lang$core$Json_Decode$succeed(msg));};var _elm_lang$html$Html_Events$onMouseDown=function _elm_lang$html$Html_Events$onMouseDown(msg){return A2(_elm_lang$html$Html_Events$on,'mousedown',_elm_lang$core$Json_Decode$succeed(msg));};var _elm_lang$html$Html_Events$onDoubleClick=function _elm_lang$html$Html_Events$onDoubleClick(msg){return A2(_elm_lang$html$Html_Events$on,'dblclick',_elm_lang$core$Json_Decode$succeed(msg));};var _elm_lang$html$Html_Events$onClick=function _elm_lang$html$Html_Events$onClick(msg){return A2(_elm_lang$html$Html_Events$on,'click',_elm_lang$core$Json_Decode$succeed(msg));};var _elm_lang$html$Html_Events$Options=F2(function(a,b){return{stopPropagation:a,preventDefault:b};});var _elm_lang$websocket$Native_WebSocket=function(){function open(url,settings){return _elm_lang$core$Native_Scheduler.nativeBinding(function(callback){try{var socket=new WebSocket(url);}catch(err){return callback(_elm_lang$core$Native_Scheduler.fail({ctor:err.name==='SecurityError'?'BadSecurity':'BadArgs',_0:err.message}));}socket.addEventListener("open",function(event){callback(_elm_lang$core$Native_Scheduler.succeed(socket));});socket.addEventListener("message",function(event){_elm_lang$core$Native_Scheduler.rawSpawn(A2(settings.onMessage,socket,event.data));});socket.addEventListener("close",function(event){_elm_lang$core$Native_Scheduler.rawSpawn(settings.onClose({code:event.code,reason:event.reason,wasClean:event.wasClean}));});return function(){if(socket&&socket.close){socket.close();}};});}function send(socket,string){return _elm_lang$core$Native_Scheduler.nativeBinding(function(callback){var result=socket.readyState===WebSocket.OPEN?_elm_lang$core$Maybe$Nothing:_elm_lang$core$Maybe$Just({ctor:'NotOpen'});try{socket.send(string);}catch(err){result=_elm_lang$core$Maybe$Just({ctor:'BadString'});}callback(_elm_lang$core$Native_Scheduler.succeed(result));});}function close(code,reason,socket){return _elm_lang$core$Native_Scheduler.nativeBinding(function(callback){try{socket.close(code,reason);}catch(err){return callback(_elm_lang$core$Native_Scheduler.fail(_elm_lang$core$Maybe$Just({ctor:err.name==='SyntaxError'?'BadReason':'BadCode'})));}callback(_elm_lang$core$Native_Scheduler.succeed(_elm_lang$core$Maybe$Nothing));});}function bytesQueued(socket){return _elm_lang$core$Native_Scheduler.nativeBinding(function(callback){callback(_elm_lang$core$Native_Scheduler.succeed(socket.bufferedAmount));});}return{open:F2(open),send:F2(send),close:F3(close),bytesQueued:bytesQueued};}();var _elm_lang$websocket$WebSocket_LowLevel$bytesQueued=_elm_lang$websocket$Native_WebSocket.bytesQueued;var _elm_lang$websocket$WebSocket_LowLevel$send=_elm_lang$websocket$Native_WebSocket.send;var _elm_lang$websocket$WebSocket_LowLevel$closeWith=_elm_lang$websocket$Native_WebSocket.close;var _elm_lang$websocket$WebSocket_LowLevel$close=function _elm_lang$websocket$WebSocket_LowLevel$close(socket){return A2(_elm_lang$core$Task$map,_elm_lang$core$Basics$always({ctor:'_Tuple0'}),A3(_elm_lang$websocket$WebSocket_LowLevel$closeWith,1000,'',socket));};var _elm_lang$websocket$WebSocket_LowLevel$open=_elm_lang$websocket$Native_WebSocket.open;var _elm_lang$websocket$WebSocket_LowLevel$Settings=F2(function(a,b){return{onMessage:a,onClose:b};});var _elm_lang$websocket$WebSocket_LowLevel$WebSocket={ctor:'WebSocket'};var _elm_lang$websocket$WebSocket_LowLevel$BadArgs={ctor:'BadArgs'};var _elm_lang$websocket$WebSocket_LowLevel$BadSecurity={ctor:'BadSecurity'};var _elm_lang$websocket$WebSocket_LowLevel$BadReason={ctor:'BadReason'};var _elm_lang$websocket$WebSocket_LowLevel$BadCode={ctor:'BadCode'};var _elm_lang$websocket$WebSocket_LowLevel$BadString={ctor:'BadString'};var _elm_lang$websocket$WebSocket_LowLevel$NotOpen={ctor:'NotOpen'};var _elm_lang$websocket$WebSocket$closeConnection=function _elm_lang$websocket$WebSocket$closeConnection(connection){var _p0=connection;if(_p0.ctor==='Opening'){return _elm_lang$core$Process$kill(_p0._1);}else{return _elm_lang$websocket$WebSocket_LowLevel$close(_p0._0);}};var _elm_lang$websocket$WebSocket$after=function _elm_lang$websocket$WebSocket$after(backoff){return _elm_lang$core$Native_Utils.cmp(backoff,1)<0?_elm_lang$core$Task$succeed({ctor:'_Tuple0'}):_elm_lang$core$Process$sleep(_elm_lang$core$Basics$toFloat(10*Math.pow(2,backoff)));};var _elm_lang$websocket$WebSocket$removeQueue=F2(function(name,state){return _elm_lang$core$Native_Utils.update(state,{queues:A2(_elm_lang$core$Dict$remove,name,state.queues)});});var _elm_lang$websocket$WebSocket$updateSocket=F3(function(name,connection,state){return _elm_lang$core$Native_Utils.update(state,{sockets:A3(_elm_lang$core$Dict$insert,name,connection,state.sockets)});});var _elm_lang$websocket$WebSocket$add=F2(function(value,maybeList){var _p1=maybeList;if(_p1.ctor==='Nothing'){return _elm_lang$core$Maybe$Just(_elm_lang$core$Native_List.fromArray([value]));}else{return _elm_lang$core$Maybe$Just(A2(_elm_lang$core$List_ops['::'],value,_p1._0));}});var _elm_lang$websocket$WebSocket$buildSubDict=F2(function(subs,dict){buildSubDict:while(true){var _p2=subs;if(_p2.ctor==='[]'){return dict;}else{if(_p2._0.ctor==='Listen'){var _v3=_p2._1,_v4=A3(_elm_lang$core$Dict$update,_p2._0._0,_elm_lang$websocket$WebSocket$add(_p2._0._1),dict);subs=_v3;dict=_v4;continue buildSubDict;}else{var _v5=_p2._1,_v6=A3(_elm_lang$core$Dict$update,_p2._0._0,function(_p3){return _elm_lang$core$Maybe$Just(A2(_elm_lang$core$Maybe$withDefault,_elm_lang$core$Native_List.fromArray([]),_p3));},dict);subs=_v5;dict=_v6;continue buildSubDict;}}}});var _elm_lang$websocket$WebSocket_ops=_elm_lang$websocket$WebSocket_ops||{};_elm_lang$websocket$WebSocket_ops['&>']=F2(function(t1,t2){return A2(_elm_lang$core$Task$andThen,t1,function(_p4){return t2;});});var _elm_lang$websocket$WebSocket$sendMessagesHelp=F3(function(cmds,socketsDict,queuesDict){sendMessagesHelp:while(true){var _p5=cmds;if(_p5.ctor==='[]'){return _elm_lang$core$Task$succeed(queuesDict);}else{var _p9=_p5._1;var _p8=_p5._0._0;var _p7=_p5._0._1;var _p6=A2(_elm_lang$core$Dict$get,_p8,socketsDict);if(_p6.ctor==='Just'&&_p6._0.ctor==='Connected'){return A2(_elm_lang$websocket$WebSocket_ops['&>'],A2(_elm_lang$websocket$WebSocket_LowLevel$send,_p6._0._0,_p7),A3(_elm_lang$websocket$WebSocket$sendMessagesHelp,_p9,socketsDict,queuesDict));}else{var _v9=_p9,_v10=socketsDict,_v11=A3(_elm_lang$core$Dict$update,_p8,_elm_lang$websocket$WebSocket$add(_p7),queuesDict);cmds=_v9;socketsDict=_v10;queuesDict=_v11;continue sendMessagesHelp;}}}});var _elm_lang$websocket$WebSocket$subscription=_elm_lang$core$Native_Platform.leaf('WebSocket');var _elm_lang$websocket$WebSocket$command=_elm_lang$core$Native_Platform.leaf('WebSocket');var _elm_lang$websocket$WebSocket$State=F3(function(a,b,c){return{sockets:a,queues:b,subs:c};});var _elm_lang$websocket$WebSocket$init=_elm_lang$core$Task$succeed(A3(_elm_lang$websocket$WebSocket$State,_elm_lang$core$Dict$empty,_elm_lang$core$Dict$empty,_elm_lang$core$Dict$empty));var _elm_lang$websocket$WebSocket$Send=F2(function(a,b){return{ctor:'Send',_0:a,_1:b};});var _elm_lang$websocket$WebSocket$send=F2(function(url,message){return _elm_lang$websocket$WebSocket$command(A2(_elm_lang$websocket$WebSocket$Send,url,message));});var _elm_lang$websocket$WebSocket$cmdMap=F2(function(_p11,_p10){var _p12=_p10;return A2(_elm_lang$websocket$WebSocket$Send,_p12._0,_p12._1);});var _elm_lang$websocket$WebSocket$KeepAlive=function _elm_lang$websocket$WebSocket$KeepAlive(a){return{ctor:'KeepAlive',_0:a};};var _elm_lang$websocket$WebSocket$keepAlive=function _elm_lang$websocket$WebSocket$keepAlive(url){return _elm_lang$websocket$WebSocket$subscription(_elm_lang$websocket$WebSocket$KeepAlive(url));};var _elm_lang$websocket$WebSocket$Listen=F2(function(a,b){return{ctor:'Listen',_0:a,_1:b};});var _elm_lang$websocket$WebSocket$listen=F2(function(url,tagger){return _elm_lang$websocket$WebSocket$subscription(A2(_elm_lang$websocket$WebSocket$Listen,url,tagger));});var _elm_lang$websocket$WebSocket$subMap=F2(function(func,sub){var _p13=sub;if(_p13.ctor==='Listen'){return A2(_elm_lang$websocket$WebSocket$Listen,_p13._0,function(_p14){return func(_p13._1(_p14));});}else{return _elm_lang$websocket$WebSocket$KeepAlive(_p13._0);}});var _elm_lang$websocket$WebSocket$Connected=function _elm_lang$websocket$WebSocket$Connected(a){return{ctor:'Connected',_0:a};};var _elm_lang$websocket$WebSocket$Opening=F2(function(a,b){return{ctor:'Opening',_0:a,_1:b};});var _elm_lang$websocket$WebSocket$BadOpen=function _elm_lang$websocket$WebSocket$BadOpen(a){return{ctor:'BadOpen',_0:a};};var _elm_lang$websocket$WebSocket$GoodOpen=F2(function(a,b){return{ctor:'GoodOpen',_0:a,_1:b};});var _elm_lang$websocket$WebSocket$Die=function _elm_lang$websocket$WebSocket$Die(a){return{ctor:'Die',_0:a};};var _elm_lang$websocket$WebSocket$Receive=F2(function(a,b){return{ctor:'Receive',_0:a,_1:b};});var _elm_lang$websocket$WebSocket$open=F2(function(name,router){return A2(_elm_lang$websocket$WebSocket_LowLevel$open,name,{onMessage:F2(function(_p15,msg){return A2(_elm_lang$core$Platform$sendToSelf,router,A2(_elm_lang$websocket$WebSocket$Receive,name,msg));}),onClose:function onClose(details){return A2(_elm_lang$core$Platform$sendToSelf,router,_elm_lang$websocket$WebSocket$Die(name));}});});var _elm_lang$websocket$WebSocket$attemptOpen=F3(function(router,backoff,name){var badOpen=function badOpen(_p16){return A2(_elm_lang$core$Platform$sendToSelf,router,_elm_lang$websocket$WebSocket$BadOpen(name));};var goodOpen=function goodOpen(ws){return A2(_elm_lang$core$Platform$sendToSelf,router,A2(_elm_lang$websocket$WebSocket$GoodOpen,name,ws));};var actuallyAttemptOpen=A2(_elm_lang$core$Task$onError,A2(_elm_lang$core$Task$andThen,A2(_elm_lang$websocket$WebSocket$open,name,router),goodOpen),badOpen);return _elm_lang$core$Process$spawn(A2(_elm_lang$websocket$WebSocket_ops['&>'],_elm_lang$websocket$WebSocket$after(backoff),actuallyAttemptOpen));});var _elm_lang$websocket$WebSocket$onEffects=F4(function(router,cmds,subs,state){var newSubs=A2(_elm_lang$websocket$WebSocket$buildSubDict,subs,_elm_lang$core$Dict$empty);var cleanup=function cleanup(newQueues){var rightStep=F3(function(name,connection,getNewSockets){return A2(_elm_lang$websocket$WebSocket_ops['&>'],_elm_lang$websocket$WebSocket$closeConnection(connection),getNewSockets);});var bothStep=F4(function(name,_p17,connection,getNewSockets){return A2(_elm_lang$core$Task$map,A2(_elm_lang$core$Dict$insert,name,connection),getNewSockets);});var leftStep=F3(function(name,_p18,getNewSockets){return A2(_elm_lang$core$Task$andThen,getNewSockets,function(newSockets){return A2(_elm_lang$core$Task$andThen,A3(_elm_lang$websocket$WebSocket$attemptOpen,router,0,name),function(pid){return _elm_lang$core$Task$succeed(A3(_elm_lang$core$Dict$insert,name,A2(_elm_lang$websocket$WebSocket$Opening,0,pid),newSockets));});});});var newEntries=A2(_elm_lang$core$Dict$union,newQueues,A2(_elm_lang$core$Dict$map,F2(function(k,v){return _elm_lang$core$Native_List.fromArray([]);}),newSubs));return A2(_elm_lang$core$Task$andThen,A6(_elm_lang$core$Dict$merge,leftStep,bothStep,rightStep,newEntries,state.sockets,_elm_lang$core$Task$succeed(_elm_lang$core$Dict$empty)),function(newSockets){return _elm_lang$core$Task$succeed(A3(_elm_lang$websocket$WebSocket$State,newSockets,newQueues,newSubs));});};var sendMessagesGetNewQueues=A3(_elm_lang$websocket$WebSocket$sendMessagesHelp,cmds,state.sockets,state.queues);return A2(_elm_lang$core$Task$andThen,sendMessagesGetNewQueues,cleanup);});var _elm_lang$websocket$WebSocket$onSelfMsg=F3(function(router,selfMsg,state){var _p19=selfMsg;switch(_p19.ctor){case'Receive':var sends=A2(_elm_lang$core$List$map,function(tagger){return A2(_elm_lang$core$Platform$sendToApp,router,tagger(_p19._1));},A2(_elm_lang$core$Maybe$withDefault,_elm_lang$core$Native_List.fromArray([]),A2(_elm_lang$core$Dict$get,_p19._0,state.subs)));return A2(_elm_lang$websocket$WebSocket_ops['&>'],_elm_lang$core$Task$sequence(sends),_elm_lang$core$Task$succeed(state));case'Die':var _p21=_p19._0;var _p20=A2(_elm_lang$core$Dict$get,_p21,state.sockets);if(_p20.ctor==='Nothing'){return _elm_lang$core$Task$succeed(state);}else{return A2(_elm_lang$core$Task$andThen,A3(_elm_lang$websocket$WebSocket$attemptOpen,router,0,_p21),function(pid){return _elm_lang$core$Task$succeed(A3(_elm_lang$websocket$WebSocket$updateSocket,_p21,A2(_elm_lang$websocket$WebSocket$Opening,0,pid),state));});}case'GoodOpen':var _p24=_p19._1;var _p23=_p19._0;var _p22=A2(_elm_lang$core$Dict$get,_p23,state.queues);if(_p22.ctor==='Nothing'){return _elm_lang$core$Task$succeed(A3(_elm_lang$websocket$WebSocket$updateSocket,_p23,_elm_lang$websocket$WebSocket$Connected(_p24),state));}else{return A3(_elm_lang$core$List$foldl,F2(function(msg,task){return A2(_elm_lang$websocket$WebSocket_ops['&>'],A2(_elm_lang$websocket$WebSocket_LowLevel$send,_p24,msg),task);}),_elm_lang$core$Task$succeed(A2(_elm_lang$websocket$WebSocket$removeQueue,_p23,A3(_elm_lang$websocket$WebSocket$updateSocket,_p23,_elm_lang$websocket$WebSocket$Connected(_p24),state))),_p22._0);}default:var _p27=_p19._0;var _p25=A2(_elm_lang$core$Dict$get,_p27,state.sockets);if(_p25.ctor==='Nothing'){return _elm_lang$core$Task$succeed(state);}else{if(_p25._0.ctor==='Opening'){var _p26=_p25._0._0;return A2(_elm_lang$core$Task$andThen,A3(_elm_lang$websocket$WebSocket$attemptOpen,router,_p26+1,_p27),function(pid){return _elm_lang$core$Task$succeed(A3(_elm_lang$websocket$WebSocket$updateSocket,_p27,A2(_elm_lang$websocket$WebSocket$Opening,_p26+1,pid),state));});}else{return _elm_lang$core$Task$succeed(state);}}}});_elm_lang$core$Native_Platform.effectManagers['WebSocket']={pkg:'elm-lang/websocket',init:_elm_lang$websocket$WebSocket$init,onEffects:_elm_lang$websocket$WebSocket$onEffects,onSelfMsg:_elm_lang$websocket$WebSocket$onSelfMsg,tag:'fx',cmdMap:_elm_lang$websocket$WebSocket$cmdMap,subMap:_elm_lang$websocket$WebSocket$subMap};var _fbonetti$elm_phoenix_socket$Phoenix_Helpers$emptyPayload=_elm_lang$core$Json_Encode$object(_elm_lang$core$Native_List.fromArray([]));var _fbonetti$elm_phoenix_socket$Phoenix_Helpers$maybeInt=function _fbonetti$elm_phoenix_socket$Phoenix_Helpers$maybeInt(maybe){var _p0=maybe;if(_p0.ctor==='Just'){return _elm_lang$core$Json_Encode$int(_p0._0);}else{return _elm_lang$core$Json_Encode$null;}};var _fbonetti$elm_phoenix_socket$Phoenix_Helpers$messageEncoder=function _fbonetti$elm_phoenix_socket$Phoenix_Helpers$messageEncoder(_p1){var _p2=_p1;return _elm_lang$core$Json_Encode$object(_elm_lang$core$Native_List.fromArray([{ctor:'_Tuple2',_0:'event',_1:_elm_lang$core$Json_Encode$string(_p2.event)},{ctor:'_Tuple2',_0:'topic',_1:_elm_lang$core$Json_Encode$string(_p2.topic)},{ctor:'_Tuple2',_0:'payload',_1:_p2.payload},{ctor:'_Tuple2',_0:'ref',_1:_fbonetti$elm_phoenix_socket$Phoenix_Helpers$maybeInt(_p2.ref)}]));};var _fbonetti$elm_phoenix_socket$Phoenix_Helpers$encodeMessage=function _fbonetti$elm_phoenix_socket$Phoenix_Helpers$encodeMessage(_p3){return A2(_elm_lang$core$Json_Encode$encode,0,_fbonetti$elm_phoenix_socket$Phoenix_Helpers$messageEncoder(_p3));};var _fbonetti$elm_phoenix_socket$Phoenix_Helpers$nullOrInt=_elm_lang$core$Json_Decode$oneOf(_elm_lang$core$Native_List.fromArray([_elm_lang$core$Json_Decode$null(_elm_lang$core$Maybe$Nothing),A2(_elm_lang$core$Json_Decode$map,_elm_lang$core$Maybe$Just,_elm_lang$core$Json_Decode$int)]));var _fbonetti$elm_phoenix_socket$Phoenix_Helpers$Message=F4(function(a,b,c,d){return{event:a,topic:b,payload:c,ref:d};});var _fbonetti$elm_phoenix_socket$Phoenix_Helpers$messageDecoder=A5(_elm_lang$core$Json_Decode$object4,_fbonetti$elm_phoenix_socket$Phoenix_Helpers$Message,A2(_elm_lang$core$Json_Decode_ops[':='],'event',_elm_lang$core$Json_Decode$string),A2(_elm_lang$core$Json_Decode_ops[':='],'topic',_elm_lang$core$Json_Decode$string),A2(_elm_lang$core$Json_Decode_ops[':='],'payload',_elm_lang$core$Json_Decode$value),A2(_elm_lang$core$Json_Decode_ops[':='],'ref',_fbonetti$elm_phoenix_socket$Phoenix_Helpers$nullOrInt));var _fbonetti$elm_phoenix_socket$Phoenix_Channel$setState=F2(function(state,channel){return _elm_lang$core$Native_Utils.update(channel,{state:state});});var _fbonetti$elm_phoenix_socket$Phoenix_Channel$onJoinError=F2(function(valueToMsg,channel){return _elm_lang$core$Native_Utils.update(channel,{onJoinError:_elm_lang$core$Maybe$Just(valueToMsg)});});var _fbonetti$elm_phoenix_socket$Phoenix_Channel$onJoin=F2(function(valueToMsg,channel){return _elm_lang$core$Native_Utils.update(channel,{onJoin:_elm_lang$core$Maybe$Just(valueToMsg)});});var _fbonetti$elm_phoenix_socket$Phoenix_Channel$onClose=F2(function(valueToMsg,channel){return _elm_lang$core$Native_Utils.update(channel,{onClose:_elm_lang$core$Maybe$Just(valueToMsg)});});var _fbonetti$elm_phoenix_socket$Phoenix_Channel$onError=F2(function(valueToMsg,channel){return _elm_lang$core$Native_Utils.update(channel,{onError:_elm_lang$core$Maybe$Just(valueToMsg)});});var _fbonetti$elm_phoenix_socket$Phoenix_Channel$withPayload=F2(function(payload,channel){return _elm_lang$core$Native_Utils.update(channel,{payload:payload});});var _fbonetti$elm_phoenix_socket$Phoenix_Channel$Channel=F9(function(a,b,c,d,e,f,g,h,i){return{name:a,payload:b,state:c,onClose:d,onError:e,onJoin:f,onJoinError:g,joinRef:h,leaveRef:i};});var _fbonetti$elm_phoenix_socket$Phoenix_Channel$Leaving={ctor:'Leaving'};var _fbonetti$elm_phoenix_socket$Phoenix_Channel$Joining={ctor:'Joining'};var _fbonetti$elm_phoenix_socket$Phoenix_Channel$Joined={ctor:'Joined'};var _fbonetti$elm_phoenix_socket$Phoenix_Channel$Errored={ctor:'Errored'};var _fbonetti$elm_phoenix_socket$Phoenix_Channel$Closed={ctor:'Closed'};var _fbonetti$elm_phoenix_socket$Phoenix_Channel$init=function _fbonetti$elm_phoenix_socket$Phoenix_Channel$init(name){return{name:name,payload:_fbonetti$elm_phoenix_socket$Phoenix_Helpers$emptyPayload,state:_fbonetti$elm_phoenix_socket$Phoenix_Channel$Closed,onClose:_elm_lang$core$Maybe$Nothing,onError:_elm_lang$core$Maybe$Nothing,onJoin:_elm_lang$core$Maybe$Nothing,onJoinError:_elm_lang$core$Maybe$Nothing,joinRef:-1,leaveRef:-1};};var _fbonetti$elm_phoenix_socket$Phoenix_Push$onError=F2(function(valueToMsg,push){return _elm_lang$core$Native_Utils.update(push,{onError:_elm_lang$core$Maybe$Just(valueToMsg)});});var _fbonetti$elm_phoenix_socket$Phoenix_Push$onOk=F2(function(valueToMsg,push){return _elm_lang$core$Native_Utils.update(push,{onOk:_elm_lang$core$Maybe$Just(valueToMsg)});});var _fbonetti$elm_phoenix_socket$Phoenix_Push$withPayload=F2(function(payload,push){return _elm_lang$core$Native_Utils.update(push,{payload:payload});});var _fbonetti$elm_phoenix_socket$Phoenix_Push$Push=F5(function(a,b,c,d,e){return{event:a,channel:b,payload:c,onOk:d,onError:e};});var _fbonetti$elm_phoenix_socket$Phoenix_Push$init=F2(function(event,channel){return A5(_fbonetti$elm_phoenix_socket$Phoenix_Push$Push,event,channel,_fbonetti$elm_phoenix_socket$Phoenix_Helpers$emptyPayload,_elm_lang$core$Maybe$Nothing,_elm_lang$core$Maybe$Nothing);});var _fbonetti$elm_phoenix_socket$Phoenix_Socket$replyDecoder=A3(_elm_lang$core$Json_Decode$object2,F2(function(v0,v1){return{ctor:'_Tuple2',_0:v0,_1:v1};}),A2(_elm_lang$core$Json_Decode_ops[':='],'status',_elm_lang$core$Json_Decode$string),A2(_elm_lang$core$Json_Decode_ops[':='],'response',_elm_lang$core$Json_Decode$value));var _fbonetti$elm_phoenix_socket$Phoenix_Socket$decodeMessage=function _fbonetti$elm_phoenix_socket$Phoenix_Socket$decodeMessage(_p0){return _elm_lang$core$Result$toMaybe(A2(_elm_lang$core$Json_Decode$decodeString,_fbonetti$elm_phoenix_socket$Phoenix_Helpers$messageDecoder,_p0));};var _fbonetti$elm_phoenix_socket$Phoenix_Socket$debugIfEnabled=function _fbonetti$elm_phoenix_socket$Phoenix_Socket$debugIfEnabled(socket){return socket.debug?_elm_lang$core$Debug$log('phx_message'):_elm_lang$core$Basics$identity;};var _fbonetti$elm_phoenix_socket$Phoenix_Socket$phoenixMessages=function _fbonetti$elm_phoenix_socket$Phoenix_Socket$phoenixMessages(socket){return A2(_elm_lang$websocket$WebSocket$listen,socket.path,_fbonetti$elm_phoenix_socket$Phoenix_Socket$decodeMessage);};var _fbonetti$elm_phoenix_socket$Phoenix_Socket$mapAll=F2(function(fn,internalMsg){var _p1=internalMsg;if(_p1.ctor==='ExternalMsg'){return _p1._0;}else{return fn(internalMsg);}});var _fbonetti$elm_phoenix_socket$Phoenix_Socket$sendMessage=F2(function(path,message){return A2(_elm_lang$websocket$WebSocket$send,path,_fbonetti$elm_phoenix_socket$Phoenix_Helpers$encodeMessage(message));});var _fbonetti$elm_phoenix_socket$Phoenix_Socket$send=F4(function(_p2,event,channel,payload){var _p3=_p2;return A2(_fbonetti$elm_phoenix_socket$Phoenix_Socket$sendMessage,_p3.path,A4(_fbonetti$elm_phoenix_socket$Phoenix_Helpers$Message,event,channel,payload,_elm_lang$core$Maybe$Just(_p3.ref)));});var _fbonetti$elm_phoenix_socket$Phoenix_Socket$off=F3(function(eventName,channelName,socket){return _elm_lang$core$Native_Utils.update(socket,{events:A2(_elm_lang$core$Dict$remove,{ctor:'_Tuple2',_0:eventName,_1:channelName},socket.events)});});var _fbonetti$elm_phoenix_socket$Phoenix_Socket$on=F4(function(eventName,channelName,onReceive,socket){return _elm_lang$core$Native_Utils.update(socket,{events:A3(_elm_lang$core$Dict$insert,{ctor:'_Tuple2',_0:eventName,_1:channelName},onReceive,socket.events)});});var _fbonetti$elm_phoenix_socket$Phoenix_Socket$push=F2(function(push$,socket){return{ctor:'_Tuple2',_0:_elm_lang$core$Native_Utils.update(socket,{pushes:A3(_elm_lang$core$Dict$insert,socket.ref,push$,socket.pushes),ref:socket.ref+1}),_1:A4(_fbonetti$elm_phoenix_socket$Phoenix_Socket$send,socket,push$.event,push$.channel,push$.payload)};});var _fbonetti$elm_phoenix_socket$Phoenix_Socket$heartbeat=function _fbonetti$elm_phoenix_socket$Phoenix_Socket$heartbeat(socket){var push$=A2(_fbonetti$elm_phoenix_socket$Phoenix_Push$init,'heartbeat','phoenix');return A2(_fbonetti$elm_phoenix_socket$Phoenix_Socket$push,push$,socket);};var _fbonetti$elm_phoenix_socket$Phoenix_Socket$leave=F2(function(channelName,socket){var _p4=A2(_elm_lang$core$Dict$get,channelName,socket.channels);if(_p4.ctor==='Just'){var _p5=_p4._0;if(_elm_lang$core$Native_Utils.eq(_p5.state,_fbonetti$elm_phoenix_socket$Phoenix_Channel$Joining)||_elm_lang$core$Native_Utils.eq(_p5.state,_fbonetti$elm_phoenix_socket$Phoenix_Channel$Joined)){var channel$=_elm_lang$core$Native_Utils.update(_p5,{state:_fbonetti$elm_phoenix_socket$Phoenix_Channel$Leaving,leaveRef:socket.ref});var socket$=_elm_lang$core$Native_Utils.update(socket,{channels:A3(_elm_lang$core$Dict$insert,channelName,channel$,socket.channels)});var push$=A2(_fbonetti$elm_phoenix_socket$Phoenix_Push$init,'phx_leave',_p5.name);return A2(_fbonetti$elm_phoenix_socket$Phoenix_Socket$push,push$,socket$);}else{return{ctor:'_Tuple2',_0:socket,_1:_elm_lang$core$Platform_Cmd$none};}}else{return{ctor:'_Tuple2',_0:socket,_1:_elm_lang$core$Platform_Cmd$none};}});var _fbonetti$elm_phoenix_socket$Phoenix_Socket$joinChannel=F2(function(channel,socket){var channel$=_elm_lang$core$Native_Utils.update(channel,{state:_fbonetti$elm_phoenix_socket$Phoenix_Channel$Joining,joinRef:socket.ref});var socket$=_elm_lang$core$Native_Utils.update(socket,{channels:A3(_elm_lang$core$Dict$insert,channel.name,channel$,socket.channels)});var push$=A5(_fbonetti$elm_phoenix_socket$Phoenix_Push$Push,'phx_join',channel.name,channel.payload,channel.onJoin,channel.onError);return A2(_fbonetti$elm_phoenix_socket$Phoenix_Socket$push,push$,socket$);});var _fbonetti$elm_phoenix_socket$Phoenix_Socket$join=F2(function(channel,socket){var _p6=A2(_elm_lang$core$Dict$get,channel.name,socket.channels);if(_p6.ctor==='Just'){var _p7=_p6._0.state;return _elm_lang$core$Native_Utils.eq(_p7,_fbonetti$elm_phoenix_socket$Phoenix_Channel$Joined)||_elm_lang$core$Native_Utils.eq(_p7,_fbonetti$elm_phoenix_socket$Phoenix_Channel$Joining)?{ctor:'_Tuple2',_0:socket,_1:_elm_lang$core$Platform_Cmd$none}:A2(_fbonetti$elm_phoenix_socket$Phoenix_Socket$joinChannel,channel,socket);}else{return A2(_fbonetti$elm_phoenix_socket$Phoenix_Socket$joinChannel,channel,socket);}});var _fbonetti$elm_phoenix_socket$Phoenix_Socket$withoutHeartbeat=function _fbonetti$elm_phoenix_socket$Phoenix_Socket$withoutHeartbeat(socket){return _elm_lang$core$Native_Utils.update(socket,{withoutHeartbeat:true});};var _fbonetti$elm_phoenix_socket$Phoenix_Socket$withHeartbeatInterval=F2(function(intervalSeconds,socket){return _elm_lang$core$Native_Utils.update(socket,{heartbeatIntervalSeconds:intervalSeconds});});var _fbonetti$elm_phoenix_socket$Phoenix_Socket$withDebug=function _fbonetti$elm_phoenix_socket$Phoenix_Socket$withDebug(socket){return _elm_lang$core$Native_Utils.update(socket,{debug:true});};var _fbonetti$elm_phoenix_socket$Phoenix_Socket$update=F2(function(msg,socket){var _p8=msg;switch(_p8.ctor){case'ChannelErrored':var channels=A3(_elm_lang$core$Dict$update,_p8._0,_elm_lang$core$Maybe$map(_fbonetti$elm_phoenix_socket$Phoenix_Channel$setState(_fbonetti$elm_phoenix_socket$Phoenix_Channel$Errored)),socket.channels);var socket$=_elm_lang$core$Native_Utils.update(socket,{channels:channels});return{ctor:'_Tuple2',_0:socket$,_1:_elm_lang$core$Platform_Cmd$none};case'ChannelClosed':var _p11=_p8._0;var _p9=A2(_elm_lang$core$Dict$get,_p11,socket.channels);if(_p9.ctor==='Just'){var _p10=_p9._0;var pushes=A2(_elm_lang$core$Dict$remove,_p10.joinRef,socket.pushes);var channels=A3(_elm_lang$core$Dict$insert,_p11,A2(_fbonetti$elm_phoenix_socket$Phoenix_Channel$setState,_fbonetti$elm_phoenix_socket$Phoenix_Channel$Closed,_p10),socket.channels);var socket$=_elm_lang$core$Native_Utils.update(socket,{channels:channels,pushes:pushes});return{ctor:'_Tuple2',_0:socket$,_1:_elm_lang$core$Platform_Cmd$none};}else{return{ctor:'_Tuple2',_0:socket,_1:_elm_lang$core$Platform_Cmd$none};}case'ChannelJoined':var _p14=_p8._0;var _p12=A2(_elm_lang$core$Dict$get,_p14,socket.channels);if(_p12.ctor==='Just'){var _p13=_p12._0;var pushes=A2(_elm_lang$core$Dict$remove,_p13.joinRef,socket.pushes);var channels=A3(_elm_lang$core$Dict$insert,_p14,A2(_fbonetti$elm_phoenix_socket$Phoenix_Channel$setState,_fbonetti$elm_phoenix_socket$Phoenix_Channel$Joined,_p13),socket.channels);var socket$=_elm_lang$core$Native_Utils.update(socket,{channels:channels,pushes:pushes});return{ctor:'_Tuple2',_0:socket$,_1:_elm_lang$core$Platform_Cmd$none};}else{return{ctor:'_Tuple2',_0:socket,_1:_elm_lang$core$Platform_Cmd$none};}case'Heartbeat':return _fbonetti$elm_phoenix_socket$Phoenix_Socket$heartbeat(socket);default:return{ctor:'_Tuple2',_0:socket,_1:_elm_lang$core$Platform_Cmd$none};}});var _fbonetti$elm_phoenix_socket$Phoenix_Socket$init=function _fbonetti$elm_phoenix_socket$Phoenix_Socket$init(path){return{path:path,debug:false,channels:_elm_lang$core$Dict$fromList(_elm_lang$core$Native_List.fromArray([])),events:_elm_lang$core$Dict$fromList(_elm_lang$core$Native_List.fromArray([])),pushes:_elm_lang$core$Dict$fromList(_elm_lang$core$Native_List.fromArray([])),ref:0,heartbeatIntervalSeconds:30,withoutHeartbeat:false};};var _fbonetti$elm_phoenix_socket$Phoenix_Socket$Socket=F8(function(a,b,c,d,e,f,g,h){return{path:a,debug:b,channels:c,events:d,pushes:e,ref:f,heartbeatIntervalSeconds:g,withoutHeartbeat:h};});var _fbonetti$elm_phoenix_socket$Phoenix_Socket$Heartbeat=function _fbonetti$elm_phoenix_socket$Phoenix_Socket$Heartbeat(a){return{ctor:'Heartbeat',_0:a};};var _fbonetti$elm_phoenix_socket$Phoenix_Socket$heartbeatSubscription=function _fbonetti$elm_phoenix_socket$Phoenix_Socket$heartbeatSubscription(socket){return socket.withoutHeartbeat?_elm_lang$core$Platform_Sub$none:A2(_elm_lang$core$Time$every,_elm_lang$core$Time$second*socket.heartbeatIntervalSeconds,_fbonetti$elm_phoenix_socket$Phoenix_Socket$Heartbeat);};var _fbonetti$elm_phoenix_socket$Phoenix_Socket$ReceiveReply=F2(function(a,b){return{ctor:'ReceiveReply',_0:a,_1:b};});var _fbonetti$elm_phoenix_socket$Phoenix_Socket$ChannelJoined=function _fbonetti$elm_phoenix_socket$Phoenix_Socket$ChannelJoined(a){return{ctor:'ChannelJoined',_0:a};};var _fbonetti$elm_phoenix_socket$Phoenix_Socket$ChannelClosed=function _fbonetti$elm_phoenix_socket$Phoenix_Socket$ChannelClosed(a){return{ctor:'ChannelClosed',_0:a};};var _fbonetti$elm_phoenix_socket$Phoenix_Socket$ChannelErrored=function _fbonetti$elm_phoenix_socket$Phoenix_Socket$ChannelErrored(a){return{ctor:'ChannelErrored',_0:a};};var _fbonetti$elm_phoenix_socket$Phoenix_Socket$ExternalMsg=function _fbonetti$elm_phoenix_socket$Phoenix_Socket$ExternalMsg(a){return{ctor:'ExternalMsg',_0:a};};var _fbonetti$elm_phoenix_socket$Phoenix_Socket$NoOp={ctor:'NoOp'};var _fbonetti$elm_phoenix_socket$Phoenix_Socket$handleInternalPhxReply=F2(function(socket,message){var msg=A2(_elm_lang$core$Maybe$andThen,_elm_lang$core$Result$toMaybe(A2(_elm_lang$core$Json_Decode$decodeValue,_fbonetti$elm_phoenix_socket$Phoenix_Socket$replyDecoder,message.payload)),function(_p15){var _p16=_p15;return A2(_elm_lang$core$Maybe$andThen,message.ref,function(ref){return A2(_elm_lang$core$Maybe$andThen,A2(_elm_lang$core$Dict$get,message.topic,socket.channels),function(channel){return _elm_lang$core$Native_Utils.eq(_p16._0,'ok')?_elm_lang$core$Native_Utils.eq(ref,channel.joinRef)?_elm_lang$core$Maybe$Just(_fbonetti$elm_phoenix_socket$Phoenix_Socket$ChannelJoined(message.topic)):_elm_lang$core$Native_Utils.eq(ref,channel.leaveRef)?_elm_lang$core$Maybe$Just(_fbonetti$elm_phoenix_socket$Phoenix_Socket$ChannelClosed(message.topic)):_elm_lang$core$Maybe$Nothing:_elm_lang$core$Maybe$Nothing;});});});return A2(_elm_lang$core$Maybe$withDefault,_fbonetti$elm_phoenix_socket$Phoenix_Socket$NoOp,msg);});var _fbonetti$elm_phoenix_socket$Phoenix_Socket$mapInternalMsgs=F2(function(socket,maybeMessage){var _p17=maybeMessage;if(_p17.ctor==='Just'){var _p19=_p17._0;var message=socket.debug?A2(_elm_lang$core$Debug$log,'Phoenix message',_p19):_p19;var _p18=message.event;switch(_p18){case'phx_reply':return A2(_fbonetti$elm_phoenix_socket$Phoenix_Socket$handleInternalPhxReply,socket,message);case'phx_error':return _fbonetti$elm_phoenix_socket$Phoenix_Socket$ChannelErrored(message.topic);case'phx_close':return _fbonetti$elm_phoenix_socket$Phoenix_Socket$ChannelClosed(message.topic);default:return _fbonetti$elm_phoenix_socket$Phoenix_Socket$NoOp;}}else{return _fbonetti$elm_phoenix_socket$Phoenix_Socket$NoOp;}});var _fbonetti$elm_phoenix_socket$Phoenix_Socket$internalMsgs=function _fbonetti$elm_phoenix_socket$Phoenix_Socket$internalMsgs(socket){return A2(_elm_lang$core$Platform_Sub$map,_fbonetti$elm_phoenix_socket$Phoenix_Socket$mapInternalMsgs(socket),_fbonetti$elm_phoenix_socket$Phoenix_Socket$phoenixMessages(socket));};var _fbonetti$elm_phoenix_socket$Phoenix_Socket$handlePhxReply=F2(function(socket,message){var msg=A2(_elm_lang$core$Maybe$andThen,_elm_lang$core$Result$toMaybe(A2(_elm_lang$core$Json_Decode$decodeValue,_fbonetti$elm_phoenix_socket$Phoenix_Socket$replyDecoder,message.payload)),function(_p20){var _p21=_p20;var _p25=_p21._1;return A2(_elm_lang$core$Maybe$andThen,message.ref,function(ref){return A2(_elm_lang$core$Maybe$andThen,A2(_elm_lang$core$Dict$get,ref,socket.pushes),function(push){var _p22=_p21._0;switch(_p22){case'ok':return A2(_elm_lang$core$Maybe$map,function(f){return function(_p23){return _fbonetti$elm_phoenix_socket$Phoenix_Socket$ExternalMsg(f(_p23));}(_p25);},push.onOk);case'error':return A2(_elm_lang$core$Maybe$map,function(f){return function(_p24){return _fbonetti$elm_phoenix_socket$Phoenix_Socket$ExternalMsg(f(_p24));}(_p25);},push.onError);default:return _elm_lang$core$Maybe$Nothing;}});});});return A2(_elm_lang$core$Maybe$withDefault,_fbonetti$elm_phoenix_socket$Phoenix_Socket$NoOp,msg);});var _fbonetti$elm_phoenix_socket$Phoenix_Socket$handleEvent=F2(function(socket,message){var _p26=A2(_elm_lang$core$Dict$get,{ctor:'_Tuple2',_0:message.event,_1:message.topic},socket.events);if(_p26.ctor==='Just'){return _fbonetti$elm_phoenix_socket$Phoenix_Socket$ExternalMsg(_p26._0(message.payload));}else{return _fbonetti$elm_phoenix_socket$Phoenix_Socket$NoOp;}});var _fbonetti$elm_phoenix_socket$Phoenix_Socket$mapExternalMsgs=F2(function(socket,maybeMessage){var _p27=maybeMessage;if(_p27.ctor==='Just'){var _p31=_p27._0;var _p28=_p31.event;switch(_p28){case'phx_reply':return A2(_fbonetti$elm_phoenix_socket$Phoenix_Socket$handlePhxReply,socket,_p31);case'phx_error':var channel=A2(_elm_lang$core$Dict$get,_p31.topic,socket.channels);var onError=A2(_elm_lang$core$Maybe$andThen,channel,function(_){return _.onError;});var msg=A2(_elm_lang$core$Maybe$map,function(f){return function(_p29){return _fbonetti$elm_phoenix_socket$Phoenix_Socket$ExternalMsg(f(_p29));}(_p31.payload);},onError);return A2(_elm_lang$core$Maybe$withDefault,_fbonetti$elm_phoenix_socket$Phoenix_Socket$NoOp,msg);case'phx_close':var channel=A2(_elm_lang$core$Dict$get,_p31.topic,socket.channels);var onClose=A2(_elm_lang$core$Maybe$andThen,channel,function(_){return _.onClose;});var msg=A2(_elm_lang$core$Maybe$map,function(f){return function(_p30){return _fbonetti$elm_phoenix_socket$Phoenix_Socket$ExternalMsg(f(_p30));}(_p31.payload);},onClose);return A2(_elm_lang$core$Maybe$withDefault,_fbonetti$elm_phoenix_socket$Phoenix_Socket$NoOp,msg);default:return A2(_fbonetti$elm_phoenix_socket$Phoenix_Socket$handleEvent,socket,_p31);}}else{return _fbonetti$elm_phoenix_socket$Phoenix_Socket$NoOp;}});var _fbonetti$elm_phoenix_socket$Phoenix_Socket$externalMsgs=function _fbonetti$elm_phoenix_socket$Phoenix_Socket$externalMsgs(socket){return A2(_elm_lang$core$Platform_Sub$map,_fbonetti$elm_phoenix_socket$Phoenix_Socket$mapExternalMsgs(socket),_fbonetti$elm_phoenix_socket$Phoenix_Socket$phoenixMessages(socket));};var _fbonetti$elm_phoenix_socket$Phoenix_Socket$listen=F2(function(socket,fn){return function(_p32){return A2(_elm_lang$core$Platform_Sub$map,_fbonetti$elm_phoenix_socket$Phoenix_Socket$mapAll(fn),_elm_lang$core$Platform_Sub$batch(_p32));}(_elm_lang$core$Native_List.fromArray([_fbonetti$elm_phoenix_socket$Phoenix_Socket$internalMsgs(socket),_fbonetti$elm_phoenix_socket$Phoenix_Socket$externalMsgs(socket),_fbonetti$elm_phoenix_socket$Phoenix_Socket$heartbeatSubscription(socket)]));});var _user$project$Mfa$renderMessage=function _user$project$Mfa$renderMessage(str){return A2(_elm_lang$html$Html$li,_elm_lang$core$Native_List.fromArray([]),_elm_lang$core$Native_List.fromArray([_elm_lang$html$Html$text(str)]));};var _user$project$Mfa$channelRow=function _user$project$Mfa$channelRow(channel){return A2(_elm_lang$html$Html$tr,_elm_lang$core$Native_List.fromArray([]),_elm_lang$core$Native_List.fromArray([A2(_elm_lang$html$Html$td,_elm_lang$core$Native_List.fromArray([]),_elm_lang$core$Native_List.fromArray([_elm_lang$html$Html$text(channel.name)])),A2(_elm_lang$html$Html$td,_elm_lang$core$Native_List.fromArray([]),_elm_lang$core$Native_List.fromArray([function(_p0){return _elm_lang$html$Html$text(_elm_lang$core$Basics$toString(_p0));}(channel.payload)])),A2(_elm_lang$html$Html$td,_elm_lang$core$Native_List.fromArray([]),_elm_lang$core$Native_List.fromArray([function(_p1){return _elm_lang$html$Html$text(_elm_lang$core$Basics$toString(_p1));}(channel.state)]))]));};var _user$project$Mfa$channelsTable=function _user$project$Mfa$channelsTable(channels){return A2(_elm_lang$html$Html$table,_elm_lang$core$Native_List.fromArray([]),_elm_lang$core$Native_List.fromArray([A2(_elm_lang$html$Html$tbody,_elm_lang$core$Native_List.fromArray([]),A2(_elm_lang$core$List$map,_user$project$Mfa$channelRow,channels))]));};var _user$project$Mfa$color=function _user$project$Mfa$color(msg){var _p2=msg;switch(_p2.ctor){case'Accepted':return A2(_elm_lang$core$Debug$log,'color','#3C8D2F');case'Rejected':return A2(_elm_lang$core$Debug$log,'color','#8D3C2F');case'Timeout':return A2(_elm_lang$core$Debug$log,'color','#DDDDDD');case'Waiting':return A2(_elm_lang$core$Debug$log,'color','#123456');default:return A2(_elm_lang$core$Debug$log,'color','#FDF');}};var _user$project$Mfa_ops=_user$project$Mfa_ops||{};_user$project$Mfa_ops['=>']=F2(function(v0,v1){return{ctor:'_Tuple2',_0:v0,_1:v1};});var _user$project$Mfa$page_waiting=function _user$project$Mfa$page_waiting(model){return A2(_elm_lang$html$Html$div,_elm_lang$core$Native_List.fromArray([]),_elm_lang$core$Native_List.fromArray([A2(_elm_lang$html$Html$div,_elm_lang$core$Native_List.fromArray([_elm_lang$html$Html_Attributes$style(_elm_lang$core$Native_List.fromArray([A2(_user$project$Mfa_ops['=>'],'background-color',_user$project$Mfa$color(model.status)),A2(_user$project$Mfa_ops['=>'],'width','600px'),A2(_user$project$Mfa_ops['=>'],'height','600px'),A2(_user$project$Mfa_ops['=>'],'border-radius','4px'),A2(_user$project$Mfa_ops['=>'],'position','absolute'),A2(_user$project$Mfa_ops['=>'],'left','center'),A2(_user$project$Mfa_ops['=>'],'top','center'),A2(_user$project$Mfa_ops['=>'],'color','white'),A2(_user$project$Mfa_ops['=>'],'display','flex'),A2(_user$project$Mfa_ops['=>'],'align-items','center'),A2(_user$project$Mfa_ops['=>'],'justify-content','center')]))]),_elm_lang$core$Native_List.fromArray([A2(_elm_lang$html$Html$div,_elm_lang$core$Native_List.fromArray([]),_elm_lang$core$Native_List.fromArray([A2(_elm_lang$html$Html$h1,_elm_lang$core$Native_List.fromArray([]),_elm_lang$core$Native_List.fromArray([_elm_lang$html$Html$text('Waiting for your acceptation...')]))])),A2(_elm_lang$html$Html$div,_elm_lang$core$Native_List.fromArray([]),_elm_lang$core$Native_List.fromArray([A2(_elm_lang$html$Html$i,_elm_lang$core$Native_List.fromArray([_elm_lang$html$Html_Attributes$class('fa fa-spinner fa-spin fa-3x fa-fw')]),_elm_lang$core$Native_List.fromArray([]))]))])),A2(_elm_lang$html$Html$div,_elm_lang$core$Native_List.fromArray([_elm_lang$html$Html_Attributes$style(_elm_lang$core$Native_List.fromArray([A2(_user$project$Mfa_ops['=>'],'top','bottom'),A2(_user$project$Mfa_ops['=>'],'color','#444')]))]),_elm_lang$core$Native_List.fromArray([]))]));};var _user$project$Mfa$userParams=_elm_lang$core$Json_Encode$object(_elm_lang$core$Native_List.fromArray([{ctor:'_Tuple2',_0:'user_id',_1:_elm_lang$core$Json_Encode$string('123')}]));var _user$project$Mfa$socketServer='ws://localhost:5000/socket/websocket';var _user$project$Mfa$Model=F5(function(a,b,c,d,e){return{newMessage:a,messages:b,phxSocket:c,ping:d,status:e};});var _user$project$Mfa$Model2=F2(function(a,b){return{status:a,phxSocket:b};});var _user$project$Mfa$ChatMessage=F3(function(a,b,c){return{user:a,body:b,value:c};});var _user$project$Mfa$chatMessageDecoder=A4(_elm_lang$core$Json_Decode$object3,_user$project$Mfa$ChatMessage,A2(_elm_lang$core$Json_Decode_ops[':='],'user',_elm_lang$core$Json_Decode$string),A2(_elm_lang$core$Json_Decode_ops[':='],'body',_elm_lang$core$Json_Decode$string),A2(_elm_lang$core$Json_Decode_ops[':='],'value',_elm_lang$core$Json_Decode$int));var _user$project$Mfa$Timeout={ctor:'Timeout'};var _user$project$Mfa$Rejected={ctor:'Rejected'};var _user$project$Mfa$Accepted={ctor:'Accepted'};var _user$project$Mfa$Waiting={ctor:'Waiting'};var _user$project$Mfa$None={ctor:'None'};var _user$project$Mfa$Ping=function _user$project$Mfa$Ping(a){return{ctor:'Ping',_0:a};};var _user$project$Mfa$NoOp={ctor:'NoOp'};var _user$project$Mfa$ShowLeftMessage=function _user$project$Mfa$ShowLeftMessage(a){return{ctor:'ShowLeftMessage',_0:a};};var _user$project$Mfa$ShowJoinedMessage=function _user$project$Mfa$ShowJoinedMessage(a){return{ctor:'ShowJoinedMessage',_0:a};};var _user$project$Mfa$LeaveChannel={ctor:'LeaveChannel'};var _user$project$Mfa$JoinChannel={ctor:'JoinChannel'};var _user$project$Mfa$page_checkout=function _user$project$Mfa$page_checkout(model){return A2(_elm_lang$html$Html$div,_elm_lang$core$Native_List.fromArray([]),_elm_lang$core$Native_List.fromArray([A2(_elm_lang$html$Html$h2,_elm_lang$core$Native_List.fromArray([]),_elm_lang$core$Native_List.fromArray([_elm_lang$html$Html$text('The total is of $ 42.0 ')])),A5(_JeremyBellows$elm_bootstrapify$Bootstrap_Buttons$btn,_JeremyBellows$elm_bootstrapify$Bootstrap_Buttons$BtnPrimary,_elm_lang$core$Native_List.fromArray([_JeremyBellows$elm_bootstrapify$Bootstrap_Buttons$BtnBlock]),_elm_lang$core$Native_List.fromArray([]),_elm_lang$core$Native_List.fromArray([_elm_lang$html$Html_Events$onClick(_user$project$Mfa$JoinChannel)]),_elm_lang$core$Native_List.fromArray([A2(_elm_lang$html$Html$i,_elm_lang$core$Native_List.fromArray([_elm_lang$html$Html_Attributes$class('fa fa-shopping-cart fa-4x fa-fw')]),_elm_lang$core$Native_List.fromArray([]))]))]));};var _user$project$Mfa$newview=function _user$project$Mfa$newview(model){var _p3=model.status;switch(_p3.ctor){case'None':return _user$project$Mfa$page_checkout(model);case'Waiting':return _user$project$Mfa$page_waiting(model);default:return A2(_elm_lang$html$Html$div,_elm_lang$core$Native_List.fromArray([]),_elm_lang$core$Native_List.fromArray([A2(_elm_lang$html$Html$i,_elm_lang$core$Native_List.fromArray([_elm_lang$html$Html_Attributes$class('fa fa-spinner fa-spin')]),_elm_lang$core$Native_List.fromArray([]))]));}};var _user$project$Mfa$ReceiveChatMessage=function _user$project$Mfa$ReceiveChatMessage(a){return{ctor:'ReceiveChatMessage',_0:a};};var _user$project$Mfa$PhoenixMsg=function _user$project$Mfa$PhoenixMsg(a){return{ctor:'PhoenixMsg',_0:a};};var _user$project$Mfa$subscriptions=function _user$project$Mfa$subscriptions(model){return A2(_fbonetti$elm_phoenix_socket$Phoenix_Socket$listen,model.phxSocket,_user$project$Mfa$PhoenixMsg);};var _user$project$Mfa$update=F2(function(msg,model){var _p4=msg;switch(_p4.ctor){case'PhoenixMsg':var _p5=A2(_fbonetti$elm_phoenix_socket$Phoenix_Socket$update,_p4._0,model.phxSocket);var phxSocket=_p5._0;var phxCmd=_p5._1;return{ctor:'_Tuple2',_0:_elm_lang$core$Native_Utils.update(model,{phxSocket:phxSocket}),_1:A2(_elm_lang$core$Platform_Cmd$map,_user$project$Mfa$PhoenixMsg,phxCmd)};case'SendMessage':var payload=_elm_lang$core$Json_Encode$object(_elm_lang$core$Native_List.fromArray([{ctor:'_Tuple2',_0:'user',_1:_elm_lang$core$Json_Encode$string('user')},{ctor:'_Tuple2',_0:'body',_1:_elm_lang$core$Json_Encode$string(model.newMessage)}]));var push$=A2(_fbonetti$elm_phoenix_socket$Phoenix_Push$withPayload,payload,A2(_fbonetti$elm_phoenix_socket$Phoenix_Push$init,'new:msg','rooms:lobby'));var _p6=A2(_fbonetti$elm_phoenix_socket$Phoenix_Socket$push,push$,model.phxSocket);var phxSocket=_p6._0;var phxCmd=_p6._1;return{ctor:'_Tuple2',_0:_elm_lang$core$Native_Utils.update(model,{newMessage:'',phxSocket:phxSocket}),_1:A2(_elm_lang$core$Platform_Cmd$map,_user$project$Mfa$PhoenixMsg,phxCmd)};case'SetNewMessage':return{ctor:'_Tuple2',_0:_elm_lang$core$Native_Utils.update(model,{newMessage:_p4._0}),_1:_elm_lang$core$Platform_Cmd$none};case'ReceiveChatMessage':var _p7=A2(_elm_lang$core$Json_Decode$decodeValue,_user$project$Mfa$chatMessageDecoder,_p4._0);if(_p7.ctor==='Ok'){var _p8=_p7._0;return{ctor:'_Tuple2',_0:_elm_lang$core$Native_Utils.update(model,{messages:A2(_elm_lang$core$List_ops['::'],A2(_elm_lang$core$Basics_ops['++'],_p8.user,A2(_elm_lang$core$Basics_ops['++'],': ',_p8.body)),model.messages)}),_1:_elm_lang$core$Platform_Cmd$none};}else{return{ctor:'_Tuple2',_0:model,_1:_elm_lang$core$Platform_Cmd$none};}case'JoinChannel':var channel=A2(_fbonetti$elm_phoenix_socket$Phoenix_Channel$onClose,_elm_lang$core$Basics$always(_user$project$Mfa$ShowLeftMessage('rooms:lobby')),A2(_fbonetti$elm_phoenix_socket$Phoenix_Channel$onJoin,_elm_lang$core$Basics$always(_user$project$Mfa$ShowJoinedMessage('rooms:lobby')),A2(_fbonetti$elm_phoenix_socket$Phoenix_Channel$withPayload,_user$project$Mfa$userParams,_fbonetti$elm_phoenix_socket$Phoenix_Channel$init('rooms:lobby'))));var _p9=A2(_fbonetti$elm_phoenix_socket$Phoenix_Socket$join,channel,model.phxSocket);var phxSocket=_p9._0;var phxCmd=_p9._1;return{ctor:'_Tuple2',_0:_elm_lang$core$Native_Utils.update(model,{phxSocket:A2(_elm_lang$core$Debug$log,'phoenix socket on join',phxSocket)}),_1:A2(_elm_lang$core$Platform_Cmd$map,_user$project$Mfa$PhoenixMsg,phxCmd)};case'LeaveChannel':var _p10=A2(_fbonetti$elm_phoenix_socket$Phoenix_Socket$leave,'rooms:lobby',model.phxSocket);var phxSocket=_p10._0;var phxCmd=_p10._1;return{ctor:'_Tuple2',_0:_elm_lang$core$Native_Utils.update(model,{phxSocket:phxSocket}),_1:A2(_elm_lang$core$Platform_Cmd$map,_user$project$Mfa$PhoenixMsg,phxCmd)};case'ShowJoinedMessage':return{ctor:'_Tuple2',_0:_elm_lang$core$Native_Utils.update(model,{messages:A2(_elm_lang$core$List_ops['::'],A2(_elm_lang$core$Basics_ops['++'],'Joined channel ',_p4._0),model.messages)}),_1:_elm_lang$core$Platform_Cmd$none};case'ShowLeftMessage':return{ctor:'_Tuple2',_0:_elm_lang$core$Native_Utils.update(model,{messages:A2(_elm_lang$core$List_ops['::'],A2(_elm_lang$core$Basics_ops['++'],'Left channel ',_p4._0),model.messages)}),_1:_elm_lang$core$Platform_Cmd$none};case'Checkout':var payload=_elm_lang$core$Json_Encode$object(_elm_lang$core$Native_List.fromArray([{ctor:'_Tuple2',_0:'user',_1:_elm_lang$core$Json_Encode$string('user')},{ctor:'_Tuple2',_0:'body',_1:_elm_lang$core$Json_Encode$string('42')}]));var push$=A2(_fbonetti$elm_phoenix_socket$Phoenix_Push$withPayload,payload,A2(_fbonetti$elm_phoenix_socket$Phoenix_Push$init,'new:msg','rooms:lobby'));var _p11=A2(_fbonetti$elm_phoenix_socket$Phoenix_Socket$push,push$,model.phxSocket);var phxSocket=_p11._0;var phxCmd=_p11._1;return{ctor:'_Tuple2',_0:_elm_lang$core$Native_Utils.update(model,{newMessage:'',phxSocket:phxSocket}),_1:A2(_elm_lang$core$Platform_Cmd$map,_user$project$Mfa$PhoenixMsg,phxCmd)};case'ReceiveAccepted':return{ctor:'_Tuple2',_0:_elm_lang$core$Native_Utils.update(model,{status:_user$project$Mfa$Accepted}),_1:_elm_lang$core$Platform_Cmd$none};case'ReceiveRejected':return{ctor:'_Tuple2',_0:_elm_lang$core$Native_Utils.update(model,{status:_user$project$Mfa$Rejected}),_1:_elm_lang$core$Platform_Cmd$none};case'ReceiveTimeout':return{ctor:'_Tuple2',_0:_elm_lang$core$Native_Utils.update(model,{status:_user$project$Mfa$Timeout}),_1:_elm_lang$core$Platform_Cmd$none};case'Ping':var _p12=A2(_elm_lang$core$Json_Decode$decodeValue,_user$project$Mfa$chatMessageDecoder,_p4._0);if(_p12.ctor==='Ok'){return{ctor:'_Tuple2',_0:_elm_lang$core$Native_Utils.update(model,{ping:_p12._0.value,status:_user$project$Mfa$Waiting}),_1:_elm_lang$core$Platform_Cmd$none};}else{return{ctor:'_Tuple2',_0:model,_1:_elm_lang$core$Platform_Cmd$none};}default:return{ctor:'_Tuple2',_0:model,_1:_elm_lang$core$Platform_Cmd$none};}});var _user$project$Mfa$SetNewMessage=function _user$project$Mfa$SetNewMessage(a){return{ctor:'SetNewMessage',_0:a};};var _user$project$Mfa$SendMessage={ctor:'SendMessage'};var _user$project$Mfa$newMessageForm=function _user$project$Mfa$newMessageForm(model){return A2(_elm_lang$html$Html$form,_elm_lang$core$Native_List.fromArray([_elm_lang$html$Html_Events$onSubmit(_user$project$Mfa$SendMessage)]),_elm_lang$core$Native_List.fromArray([A2(_elm_lang$html$Html$input,_elm_lang$core$Native_List.fromArray([_elm_lang$html$Html_Attributes$type$('text'),_elm_lang$html$Html_Attributes$value(model.newMessage),_elm_lang$html$Html_Events$onInput(_user$project$Mfa$SetNewMessage)]),_elm_lang$core$Native_List.fromArray([]))]));};var _user$project$Mfa$view=function _user$project$Mfa$view(model){return A2(_elm_lang$html$Html$div,_elm_lang$core$Native_List.fromArray([]),_elm_lang$core$Native_List.fromArray([A2(_elm_lang$html$Html$h3,_elm_lang$core$Native_List.fromArray([]),_elm_lang$core$Native_List.fromArray([_elm_lang$html$Html$text('Channels:')])),A2(_elm_lang$html$Html$div,_elm_lang$core$Native_List.fromArray([]),_elm_lang$core$Native_List.fromArray([A2(_elm_lang$html$Html$button,_elm_lang$core$Native_List.fromArray([_elm_lang$html$Html_Events$onClick(_user$project$Mfa$JoinChannel)]),_elm_lang$core$Native_List.fromArray([_elm_lang$html$Html$text('Join channel')])),A2(_elm_lang$html$Html$button,_elm_lang$core$Native_List.fromArray([_elm_lang$html$Html_Events$onClick(_user$project$Mfa$LeaveChannel)]),_elm_lang$core$Native_List.fromArray([_elm_lang$html$Html$text('Leave channel')]))])),_user$project$Mfa$channelsTable(_elm_lang$core$Dict$values(model.phxSocket.channels)),A2(_elm_lang$html$Html$br,_elm_lang$core$Native_List.fromArray([]),_elm_lang$core$Native_List.fromArray([])),A2(_elm_lang$html$Html$h3,_elm_lang$core$Native_List.fromArray([]),_elm_lang$core$Native_List.fromArray([_elm_lang$html$Html$text('Messages:')])),_user$project$Mfa$newMessageForm(model),A2(_elm_lang$html$Html$ul,_elm_lang$core$Native_List.fromArray([]),function(_p13){return _elm_lang$core$List$reverse(A2(_elm_lang$core$List$map,_user$project$Mfa$renderMessage,_p13));}(model.messages))]));};var _user$project$Mfa$ReceiveTimeout=function _user$project$Mfa$ReceiveTimeout(a){return{ctor:'ReceiveTimeout',_0:a};};var _user$project$Mfa$ReceiveRejected=function _user$project$Mfa$ReceiveRejected(a){return{ctor:'ReceiveRejected',_0:a};};var _user$project$Mfa$ReceiveAccepted=function _user$project$Mfa$ReceiveAccepted(a){return{ctor:'ReceiveAccepted',_0:a};};var _user$project$Mfa$initPhxSocket=A4(_fbonetti$elm_phoenix_socket$Phoenix_Socket$on,'timeout','rooms:lobby',_user$project$Mfa$ReceiveTimeout,A4(_fbonetti$elm_phoenix_socket$Phoenix_Socket$on,'rejected','rooms:lobby',_user$project$Mfa$ReceiveRejected,A4(_fbonetti$elm_phoenix_socket$Phoenix_Socket$on,'accepted','rooms:lobby',_user$project$Mfa$ReceiveAccepted,A4(_fbonetti$elm_phoenix_socket$Phoenix_Socket$on,'waiting','rooms:lobby',_user$project$Mfa$Ping,_fbonetti$elm_phoenix_socket$Phoenix_Socket$withDebug(_fbonetti$elm_phoenix_socket$Phoenix_Socket$init(_user$project$Mfa$socketServer))))));var _user$project$Mfa$initModel=A5(_user$project$Mfa$Model,'',_elm_lang$core$Native_List.fromArray([]),_user$project$Mfa$initPhxSocket,0,_user$project$Mfa$None);var _user$project$Mfa$init={ctor:'_Tuple2',_0:_user$project$Mfa$initModel,_1:_elm_lang$core$Platform_Cmd$none};var _user$project$Mfa$main={main:_elm_lang$html$Html_App$program({init:_user$project$Mfa$init,update:_user$project$Mfa$update,view:_user$project$Mfa$newview,subscriptions:_user$project$Mfa$subscriptions})};var _user$project$Mfa$Checkout={ctor:'Checkout'};var Elm={};Elm['Mfa']=Elm['Mfa']||{};_elm_lang$core$Native_Platform.addPublicModule(Elm['Mfa'],'Mfa',typeof _user$project$Mfa$main==='undefined'?null:_user$project$Mfa$main);if(typeof define==="function"&&define['amd']){define([],function(){return Elm;});return;}if((typeof module==='undefined'?'undefined':_typeof(module))==="object"){module['exports']=Elm;return;}var globalElm=this['Elm'];if(typeof globalElm==="undefined"){this['Elm']=Elm;return;}for(var publicModule in Elm){if(publicModule in globalElm){throw new Error('There are two Elm modules called `'+publicModule+'` on this page! Rename one of them.');}globalElm[publicModule]=Elm[publicModule];}}).call(undefined);
});
...
var elmDiv = document.getElementById('elm-container'); // Brunch automatically concatenates all files in your
...
var elmApp = Elm.Mfa.embed(elmDiv);
// const elmDiv = document.querySelector('#elm-container');
// const elmApp = Elm.Mfa.embed(elmDiv);
});
