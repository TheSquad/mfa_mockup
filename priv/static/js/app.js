...
var _user$project$Mfa$Model = F3(
	function (a, b, c) {
		return {newMessage: a, messages: b, phxSocket: c};
	});
var _user$project$Mfa$ChatMessage = F2(
	function (a, b) {
		return {user: a, body: b};
	});
var _user$project$Mfa$chatMessageDecoder = A3(
	_elm_lang$core$Json_Decode$object2,
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				function (_p11) {
					return _elm_lang$core$List$reverse(
						A2(_elm_lang$core$List$map, _user$project$Mfa$renderMessage, _p11));
				}(model.messages))
			]));
};
					...
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								'background-color',
								_user$project$Mfa$color(_user$project$Mfa$Timeout)),
								A2(_user$project$Mfa_ops['=>'], 'cursor', 'move'),
								A2(_user$project$Mfa_ops['=>'], 'width', '100px'),
								A2(_user$project$Mfa_ops['=>'], 'height', '100px'),
